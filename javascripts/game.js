...
function setupAutobuyerHTMLandData() {
  buyAutobuyer = function (id) {
    if (
      player.infinityUpgradesRespecced != undefined &&
      player.autobuyers[id].interval == 100 &&
      id > 8
    ) {
      if (
        player.autobuyers[id].bulkBought ||
        player.infinityPoints.lt(1e4) ||
        id > 10
      )
        return;
    ...
    if (
      (player.aarexModifications.ngmX > 3 && id != 11
        ? player.galacticSacrifice.galaxyPoints
        : player.infinityPoints
      ).lt(player.autobuyers[id].cost)
    )
      return false;
    if (player.autobuyers[id].bulk >= 1e100) return false;
    if (player.aarexModifications.ngmX > 3 && id != 11)
      player.galacticSacrifice.galaxyPoints = player.galacticSacrifice.galaxyPoints.minus(
    ...
    if (player.autobuyers[id].interval <= 100) {
      ...
      player.autobuyers[id].interval = Math.max(
        player.autobuyers[id].interval *
          (player.aarexModifications.ngp3c ? 0.3 : 0.6),
        100
      );
  ...
  for (let r = 1; r < 5; r++) {
    ...
    for (let c = 1; c < 5; c++) {
      ...
      col.innerHTML =
        "<button id='infi" +
        (c * 10 + r) +
        "' class='infinistorebtn" +
        c +
        "'></button>";
    }
  }
  document.getElementById("infi14").innerHTML =
    "Decrease the number of Dimensions needed for Dimension Boosts and Galaxies by 9<br>Cost: 1 IP";
  document.getElementById("infi24").innerHTML =
    "Antimatter Galaxies are twice as effective<br>Cost: 2 IP";
...
function setupPCTableHTMLandData() {
  ...
  for (let d = 1; d < 9; d++) {
    ...
    var html =
      '<td class="rel" id="D' + d + '" align="right" width="32%"> </td>';
    html += '<td id="A' + d + '"></td>';
    html +=
      '<td align="right" width="10%"><button id="B' +
      d +
      '" style="color:black; height: 25px; font-size: 10px; width: 135px" class="storebtn" onclick="buyOneDimension(' +
      d +
      ')"></button></td>';
    html +=
      '<td align="right" width="10%"><button id="M' +
      d +
      '" style="color:black; width:210px; height: 25px; font-size: 10px" class="storebtn" onclick="buyManyDimension(' +
      d +
      ')"></button></td>';
    html +=
      '<td id="CondenseDiv' +
      d +
      '" style="display: none;" align="right" width="10%"><button id="Condense' +
      d +
      '" style="color:black; width:210px; height: 25px; font-size: 10px" class="storebtn" onclick="condenseDimension(' +
      d +
      ')"></button></td>';
    row.innerHTML = html;
    ...
    var html =
      ...
      '" width="41%">' +
      DISPLAY_NAMES[d] +
      " Paradox Dimension x1</td>";
    html += '<td id="pA' + d + '">0 (0)</td>';
    html +=
      '<td align="right" width="10%"><button id="pB' +
      d +
      '" style="color:black; width:195px; height:30px" class="storebtn" align="right" onclick="buyPD(' +
      d +
      ')">Cost: ??? Px</button></td></tr>';
    row.innerHTML = html;
    ...
    var html =
      ...
      '" width="41%">' +
      DISPLAY_NAMES[d] +
      " Emperor Dimension x1</td>";
    html += '<td id="empAmount' + d + '"></td>';
    html +=
      '<td><span class="empQuarks" id="empQuarks' +
      d +
      '">0</span> preons/s</td>';
    html +=
      '<td align="right" width="2.5%"><button id="empFeedMax' +
      d +
      '" style="color:black; width:70px; font-size:10px" class="storebtn" align="right" onclick="feedReplicant(' +
      d +
      ', true)">Max</button></td>';
    html +=
      '<td align="right" width="7.5%"><button id="empFeed' +
      d +
      '" style="color:black; width:195px; height:25px; font-size:10px" class="storebtn" align="right" onclick="feedReplicant(' +
      d +
      ')">Feed (0%)</button></td>';
    html +=
      '<td id="empCondenseDiv' +
      d +
      '" style="display: none;" align="right" width="10%"><button id="empCondense' +
      d +
      '" style="color:black; width:210px; height: 25px; font-size: 10px" class="storebtn" onclick="condenseEmpDimension(' +
      d +
      ')"></button></td>';
    row.innerHTML = html;
  }
  ...
  for (var c = 0; c < 3; c++) {
    ...
    var branchUpgrades = [
      "Gain <span id='" +
        ...
        " quark spins, but " +
        color +
        " quarks decay <span id='" +
        color +
        "UpgSpeed1'></span> faster.",
      "The gain of " +
        color +
        " <span id='" +
        color +
        "UpgName2'></span> quarks is multiplied by x and then raised to the power of x.",
      ["Red", "Green", "Blue"][c] +
        " <span id='" +
        color +
        "UpgName3'></span> quarks decay<span id='" +
        color +
        "UpgEffDesc'> 4x</span> slower."
    ]; //might need to change this to just "slower" once we have 1000+ upgrade 3's
    ...
    var html =
      ...
      '" id="' +
      color +
      'QuarksToD" style="font-size: 35px">0</span> ' +
      color +
      " quarks.<br>";
    html +=
      '<button class="storebtn" id="' +
      color +
      'UnstableGain" style="width: 240px; height: 80px" onclick="unstableQuarks(\'' +
      shorthand +
      "')\"></button><br>";
    html +=
      'You have <span class="' +
      ...
      '" id="' +
      color +
      'QuarkSpin" style="font-size: 35px">0.0</span> ' +
      color +
      " quark spin.";
    html +=
      '<span class="' +
      ...
      '" id="' +
      color +
      'QuarkSpinProduction" style="font-size: 25px">+0/s</span><br>';
    html +=
      "You have <span class='" +
      color +
      "' id='" +
      color +
      "UnstableQuarks' style='font-size: 35px'>0</span> " +
      color +
      " <span id='" +
      shorthand +
      "UQName'></span> quarks.<br>";
    ...
    for (var u = 1; u <= 3; u++) {
      html +=
        "<td style='vertical-align: 0'><button class='gluonupgrade unavailablebtn' id='" +
        color +
        "upg" +
        u +
        "' onclick='buyBranchUpg(\"" +
        shorthand +
        '", ' +
        u +
      ...
      html +=
        (u == 2
          ? "<br><button class='storebtn' style='width: 190px' onclick='maxBranchUpg(\"" +
            shorthand +
            "\")'>Max all upgrades</button>" +
            "<br><button class='storebtn' style='width: 190px; font-size:10px' onclick='maxBranchUpg(\"" +
            shorthand +
            "\", true)'>Max 2nd and 3rd upgrades</button>"
          : "") + "</td>";
    }
    html +=
      "</tr></tr><td></td><td><button class='gluonupgrade unavailablebtn' id='" +
      shorthand +
      "RadioactiveDecay' style='font-size:9px' onclick='radioactiveDecay(\"" +
      shorthand +
      "\")'>Reset to strengthen the 1st upgrade, but nerf this branch.<br><span id='" +
      shorthand +
      "RDReq'></span><br>Radioactive Decays: <span id='" +
      shorthand +
      "RDLvl'></span></button></td><td></td>";
    html += "</tr></table>";
...
function setupNanofieldHTMLandData() {
  ...
  var row = 0;
  nfRewards.insertRow(0).innerHTML =
    "<td></td><td id='maxNanoCondenseAll' style='display: none; text-align: center; height: 20px;' colspan='2' onclick='maxNanoCondenseAll()' class='storebtn'>Max All Condensers</td><td></td>";
  for (var r = 1; r <= 8; r += 4) {
    row++;
    nfRewards.insertRow(row).innerHTML =
      "<td id='nfRewardHeader" +
      r +
      "' class='milestoneText'></td>" +
      "<td id='nfRewardHeader" +
      (r + 1) +
      "' class='milestoneText'></td>" +
      "<td id='nfRewardHeader" +
    ...
    row++;
    nfRewards.insertRow(row).innerHTML =
      "<td><button class='nfRewardlocked' id='nfReward" +
      r +
      "'></button></td>" +
      "<td><button class='nfRewardlocked' id='nfReward" +
      (r + 1) +
    ...
    row++;
    nfRewards.insertRow(row).innerHTML =
      "<td><button class='nfCondlocked' id='nfCond" +
      r +
      "' style='display: none' onclick='condenseNanoReward(" +
      r +
      ")'></button></td>" +
      "<td><button class='nfCondlocked' id='nfCond" +
      (r + 1) +
...
function setupQuantumChallenges() {
  ...
  var modDiv =
    '<button class="storebtn" id="qcms_normal" onclick="showQCModifierStats(\'\')">Normal</button>';
  for (var m = 0; m < qcm.modifiers.length; m++) {
    var id = qcm.modifiers[m];
    modDiv +=
      ' <button class="storebtn" id="qcms_' +
      id +
      '" onclick="showQCModifierStats(\'' +
      id +
      "')\">" +
      (qcm.names[id] || "???") +
      "</button>";
...
function setupBraveMilestones() {
  for (var m = 1; m < 17; m++)
    document.getElementById("braveMilestone" + m).textContent =
      getFullExpansion(tmp.bm[m - 1]) + "x quantumed";
}
...
function setupBosonicExtraction() {
  ...
  for (var g2 = 2; g2 <= br.maxLimit; g2++) {
    ...
    for (var g1 = 1; g1 < g2; g1++) {
      ...
      col.innerHTML =
        "<button id='bEn" +
        id +
        "' class='gluonupgrade unavailablebtn' style='font-size: 9px' onclick='takeEnchantAction(" +
        id +
        ")'><span id='bEnDesc" +
        id +
        "'>" +
        ...
        id +
        "'></span><br>" +
        "Cost: <span id='bEnG1Cost" +
        id +
        "'></span> <div class='bRune' type='" +
        g1 +
        "'></div> & <span id='bEnG2Cost" +
        id +
        "'></span> <div class='bRune' type='" +
        g2 +
        "'></div></button><br>";
  ...
  for (var g = 1; g <= br.maxLimit; g++)
    toeDiv +=
      ' <button id="typeToExtract' +
      g +
      '" class="storebtn" onclick="changeTypeToExtract(' +
      g +
      ')" style="width: 25px; font-size: 12px"><div class="bRune" type="' +
      g +
      '"></div></button>';
  ...
  for (r = 1; r <= bu.maxRows; r++) {
    ...
    for (c = 1; c < 6; c++) {
      ...
      col.innerHTML =
        "<button id='bUpg" +
        id +
        "' class='gluonupgrade unavailablebtn' style='font-size: 9px' onclick='buyBosonicUpgrade(" +
        id +
        ")'><span id='bUpg" +
        id +
        "Desc'>???</span>" +
        "<br>" +
        (bu.effects[id] !== undefined
          ? "Currently: <span id='bUpgEffect" + id + "'>0</span><br>"
          : "") +
        "Cost: <span id='bUpgCost" +
        id +
        "'></span> Bosonic Antimatter<br>" +
        "Requires: <span id='bUpgG1Req" +
        id +
        "'></span> <div class='bRune' type='" +
        bu.reqData[id][2] +
        "'></div> & <span id='bUpgG2Req" +
        id +
        "'></span> <div class='bRune' type='" +
        bu.reqData[id][4] +
        "'></div></button>";
...
function setupHiggsMechanism() {
  ...
  for (r = 1; r <= Math.ceil(hm.limit / 3); r++) {
    ...
    for (c = 1; c <= Math.min(hm.limit - 3 * (r - 1), 3); c++) {
      ...
      col.innerHTML =
        "<br><h2 style='font-size: 25px;' class='glowspan'>" +
        data.title +
        "<span id='hm" +
        type +
        "sel'></span></h2>Mass: <b id='hm" +
        type +
        "'>0</b> amu <span style='font-size: 15px;'>(+<span id='hm" +
        type +
        "gain'>0</span> amu/s)</span><br>Effect: <b id='hm" +
        type +
        "eff'>???</b><br><button id='hm" +
        type +
        "selectbtn' class='storebtn' onclick='toggleHiggsMech(" +
        (x - 1) +
        ")'>Toggle</button>";
    }
  }
...
function updateNewPlayer(reseted) {
  if (reseted) {
    var modesChosen = {
      ...
      ngp:
        player.aarexModifications.ngp4V !== undefined
          ? 2
          : player.aarexModifications.newGamePlusVersion !== undefined
          ? 1
          : 0,
      arrows: player.aarexModifications.newGameExpVersion !== undefined,
      ngpp:
        player.meta == undefined
          ? false
          : player.aarexModifications.ngp3lV
          ? 3
          : tmp.ngp3
          ? 2
          : 1,
      ngmm: player.aarexModifications.ngmX
        ? player.aarexModifications.ngmX - 1
        : player.galacticSacrifice !== undefined
        ? 1
        : 0,
      rs:
        player.infinityUpgradesRespecced != undefined
          ? 2
          : player.boughtDims !== undefined,
      ngud:
        player.aarexModifications.nguspV !== undefined
          ? 3
          : player.aarexModifications.ngudpV !== undefined
          ? 2
          : player.exdilation !== undefined
          ? 1
          : 0,
  ...
  player = {
    money: new Decimal(
      modesChosen.ngmm > 2 ? 200 : modesChosen.ngp > 1 ? 20 : 10
    ),
    ...
    replicanti: {
      ...
      intervalCost: new Decimal(
        modesChosen.ngmm ? 1e80 : modesChosen.rs == 1 ? 1e150 : 1e140
      ),
      gal: 0,
      galaxies: 0,
  ...
  if (modesChosen.ngopwd) doOverPoweredNewPlayer();
...
function doNGPlusOneNewPlayer() {
  ...
  for (i = 1; i <= 13; i++) {
    // get all achievements up to and including row 13
    for (j = 1; j <= 8; j++) {
...
function doNGPlusTwoNewPlayer() {
  ...
  for (dim = 1; dim < 9; dim++)
    player.meta[dim] = { amount: 0, bought: 0, cost: initCost[dim] };
...
function doNGPlusThreeNewPlayer() {
  ...
  for (d = 1; d < 9; d++)
    tmp.qu.emperorDimensions[d] = { workers: 0, progress: 0, perm: 0 };
...
function doOverPoweredNewPlayer() {
  player.money = new Decimal("1e250");
}
...
function doNGEXPNewPlayer() {
  ...
  for (u = 1; u < 5; u++)
    player.infinityUpgrades.push("skipReset" + (u > 3 ? "Galaxy" : u));
  player.resets = 4;
}
...
function updateChartValues() {
  player.options.chart.duration = Math.min(
    Math.max(parseInt(document.getElementById("chartDurationInput").value), 1),
    300
  );
  document.getElementById("chartDurationInput").value =
    player.options.chart.duration;
  player.options.chart.updateRate = Math.min(
    Math.max(
      parseInt(document.getElementById("chartUpdateRateInput").value),
      50
    ),
    10000
  );
  ...
  if (
    player.options.chart.updateRate <= 200 &&
    player.options.chart.duration >= 30 &&
    player.options.chart.warning === 0
  ) {
    alert(
      "Warning: Setting the duration and update rate to more demanding values can cause performance issues."
    );
    player.options.chart.warning = 1;
  }
  if (
    (player.options.chart.duration / player.options.chart.updateRate) * 1000 >=
      1000 &&
    player.options.chart.warning !== 2
  ) {
    alert(
      "Warning: You have set the duration and update rate quite high, make sure you know what you're doing or have a good computer before using the chart."
    );
    player.options.chart.warning = 2;
  }
}
...
function setTheme(name) {
  ...
  document.getElementById("theme").innerHTML =
    "<p style='font-size:15px'>Themes</p>Current theme: " + themeName;
  document.getElementById("chosenTheme").textContent =
...
function showTab(tabName, init) {
  if (tabName == "quantumtab" && !player.masterystudies) {
    alert(
      "Because Quantum was never fully developed due to the abandonment of development, you cannot access the Quantum tab in NG++. This is the definitive endgame."
    );
    return;
  }
  ...
  if (oldTab !== tabName) {
    ...
    if (
      (document.getElementById("antimatterdimensions").style.display !=
        "none" ||
        document.getElementById("metadimensions").style.display != "none") &&
      player.aarexModifications.progressBar &&
      tabName == "dimensions"
    )
    ...
    if (
      (document.getElementById("timestudies").style.display != "none" ||
        document.getElementById("ers_timestudies").style.display != "none" ||
        document.getElementById("masterystudies").style.display != "none") &&
      tabName == "eternitystore"
    )
    ...
    if (tabName == "eternitystore") {
      if (
        document.getElementById("timestudies") !== "none" ||
        document.getElementById("masterystudies") !== "none" ||
        document.getElementById("dilation") !== "none" ||
        document.getElementById("blackhole") !== "none"
      )
        resizeCanvas();
...
function updateMoney() {
  document.getElementById("coinAmount").textContent = shortenMoney(
    player.money
  );
  ...
  //TODO
    ...
    if (player.pSac !== undefined && player.matter.gt(0))
      txt +=
        ...
        timeDisplayShort(
          Math.max(
            player.money.div(player.matter).log(tmp.mv) * getEC12Mult(),
            0
          )
        ) +
        (extra
          ? " + " +
            timeDisplayShort(
              (extra - player.pSac.dims.extraTime) * 10 * getEC12Mult()
            )
          : "") +
        " left until matter reset)";
  ...
  if (isADSCRunning()) {
    ...
    element3.innerHTML =
      formatValue(player.options.notation, productAllTotalBought(), 2, 1) +
      "x multiplier on all dimensions (product of " +
      (player.tickspeedBoosts != undefined &&
      (inNC(13) || player.currentChallenge == "postc1")
        ? "1+log10(amount)"
        : "bought") +
      (mult == 1 ? "" : "*" + shorten(mult)) +
      ").";
  ...
  if (inNC(14) && player.aarexModifications.ngmX > 3)
    document.getElementById("c14Resets").textContent =
      "You have " + getFullExpansion(10 - getTotalResets()) + " resets left.";
  if (player.pSac !== undefined)
    document.getElementById("ec12Mult").textContent =
      "Time speed: 1 / " + shorten(getEC12Mult()) + "x";
}
...
function updateCoinPerSec() {
  ...
  element.textContent =
    "You are getting " + shortenND(ret) + " antimatter per second.";
}

var clickedAntimatter;
function onAntimatterClick() {
  clickedAntimatter++;
  if (!tmp.ngp3l && clickedAntimatter >= 10)
    giveAchievement("This is NOT a clicker game!");
}
...
function getInfinitiedGain() {
  ...
  if (player.timestudy.studies.includes(35) && player.aarexModifications.ngp3c)
    infGain = nM(infGain, ts35Eff());
  if (player.achievements.includes("r133") && player.meta)
    infGain = nM(player.dilation.dilatedTime.pow(0.25).max(1), infGain);
  return nA(
    infGain,
    player.achievements.includes("r87") && player.galacticSacrifice ? 249 : 0
  );
}
...
function getEternitied() {
  ...
  if (banked && (inQC(0) || (hasNU(10) && !tmp.ngp3c)))
...
function updateWorstChallengeBonus() {
  ...
  if (player.aarexModifications.ngmX >= 4)
    eff = eff.times(Decimal.pow(eff.plus(10).log10(), 5));
...
function sacrificeConf() {
  ...
  document.getElementById("sacConfirmBtn").textContent =
    "Sacrifice confirmation: O" +
    (player.options.sacrificeConfirmation ? "N" : "FF");
}
...
function toggleLogRateChange() {
  player.aarexModifications.logRateChange = !player.aarexModifications
    .logRateChange;
  document.getElementById("toggleLogRateChange").textContent =
    "Logarithm rate: O" +
    (player.aarexModifications.logRateChange ? "N" : "FF");
  dimDescEnd = (player.aarexModifications.logRateChange ? " OoM" : "%") + "/s)";
}

function toggleTabsSave() {
  player.aarexModifications.tabsSave.on = !player.aarexModifications.tabsSave
    .on;
  document.getElementById("tabsSave").textContent =
    "Saved tabs: O" + (player.aarexModifications.tabsSave.on ? "N" : "FF");
}

function updatePerformanceTicks() {
  if (player.aarexModifications.performanceTicks)
    document.getElementById("updaterateslider").min = 1;
  else {
    slider.min = 33;
    if (player.options.updateRate < 33) {
      ...
      sliderText.textContent =
        "Update rate: " + player.options.updateRate + "ms";
      startInterval();
    }
  }
  document.getElementById("performanceTicks").textContent =
    "Performance ticks: " +
    ["OFF", "LOW", "MEDIUM", "HIGH"][
      (player.aarexModifications.performanceTicks || 0) + 0
    ];
}

function togglePerformanceTicks() {
  player.aarexModifications.performanceTicks =
    ((player.aarexModifications.performanceTicks || 0) + 1) % 4;
...
function updateCosts() {
  ...
  if (
    ...
    for (var i = 1; i < 9; i++) {
      ...
      document.getElementById("B" + i).className = cost.lte(resource)
        ? "storebtn"
        : "unavailablebtn";
      document.getElementById("B" + i).textContent =
        costPart + shortenPreInfCosts(cost);
      document.getElementById("M" + i).className = cost
        .times(10 - dimBought(i))
        .lte(resource)
        ? "storebtn"
        : "unavailablebtn";
      document.getElementById("M" + i).textContent =
        until10CostPart + shortenPreInfCosts(cost.times(10 - dimBought(i)));
      document.getElementById("CondenseDiv" + i).style.display = player
        .aarexModifications.ngp3c
        ? ""
        : "none";
  ...
  document.getElementById("tickSpeed").textContent =
    costPart + shortenPreInfCosts(player.tickSpeedCost);
}
...
function updateChallenges() {
  var buttons = Array.from(
    document.getElementById("normalchallenges").getElementsByTagName("button")
  ).concat(
    Array.from(
      document.getElementById("breakchallenges").getElementsByTagName("button")
    )
  );
  ...
  document.getElementById(
    ...
    player.infinitied < 1 && player.eternities < 1 && !quantumed ? "none" : "";
  if (inQC(4)) {
  ...
  for (c = 0; c < order.length; c++)
    document.getElementById(
      ...
      player.postChallUnlocked < c + 1 ? "none" : "";
}
...
function getTotalECComps() {
  ...
  if (l == 0) return 0;
    ...
    return Object.values(player.eternityChalls).reduce(
      (a, c) => (a || 0) + (c || 0)
    );
}
...
function updateEternityChallenges() {
  ...
  for (ec = 1; ec < 15; ec++) {
    ...
    document.getElementById(property + "div").style.display = ecdata
      ? "inline-block"
      : "none";
    document.getElementById(property).textContent =
      ecdata > 4 ? "Completed" : "Locked";
    document.getElementById(property).className =
      ecdata > 4 ? "completedchallengesbtn" : "lockedchallengesbtn";
  }
  if (player.eternityChallUnlocked > 0) {
    ...
    document.getElementById(property).textContent = onchallenge
      ? "Running"
      : "Start";
    document.getElementById(property).className = onchallenge
      ? "onchallengebtn"
      : "challengesbtn";
  }
  if (inQC("8c")) {
  ...
  document.getElementById("eterctabbtn").parentElement.style.display = locked
    ? "none"
    : "";
  document.getElementById("autoEC").style.display =
    quantumed && tmp.ngp3 ? "inline-block" : "none";
  if (quantumed && tmp.ngp3)
    document.getElementById("autoEC").className = tmp.qu.autoEC
      ? "timestudybought"
      : "storebtn";
}
...
function toggleChallengeRetry() {
  ...
  document.getElementById("retry").textContent =
    "Automatically retry challenges: O" +
    (player.options.retryChallenge ? "N" : "FF");
}
...
document.getElementById("news").onclick = function () {
  ...
  if (
    ...
    ghostified &&
    (player.options.secrets === undefined ||
      player.options.secrets.ghostlyNews === undefined)
  ) {
...
document.getElementById("maxall").onclick = function () {
  ...
  if (player.aarexModifications.ngp3c)
    for (let i = 1; i <= 8; i++) maxCondense(i);
  if (
    player.currentChallenge !== "challenge14" ||
    player.aarexModifications.ngmX !== 2
  )
    buyMaxTickSpeed();
  ...
  if (
    ...
    if (name == "postinfi53")
      for (tier = 1; tier <= 8; tier++) {
        ...
        dim.cost = Decimal.pow(getIDCostMult(tier), dim.baseAmount / 10).times(
          infBaseCost[tier]
        );
      }
  }
...
function getIPMultPower() {
  ...
  if (
    player.galacticSacrifice &&
    player.galacticSacrifice.upgrades.includes(53)
  )
    ret += Math.pow(
      1.25,
      -15e4 / player.galacticSacrifice.galaxyPoints.log10()
    );
  return ret;
}
function canBuyIPMult() {
  ...
  return (
    (player.aarexModifications.ngp3c ||
...
document.getElementById("infiMult").onclick = function () {
  if (canBuyIPMult()) {
    ...
    if (
      ...
      player.autobuyers[11].priority = Decimal.times(
...
function updateEternityUpgrades() {
  ...
  if (player.exdilation != undefined && player.dilation.studies.includes(1)) {
    ...
    document.getElementById(
      "eter7"
    ).className = player.eternityUpgrades.includes(7)
      ? "eternityupbtnbought"
      : player.eternityPoints.gte("1e1500")
      ? "eternityupbtn"
      : "eternityupbtnlocked";
    document.getElementById(
      "eter8"
    ).className = player.eternityUpgrades.includes(8)
      ? "eternityupbtnbought"
      : player.eternityPoints.gte("1e2000")
      ? "eternityupbtn"
      : "eternityupbtnlocked";
    document.getElementById(
      "eter9"
    ).className = player.eternityUpgrades.includes(9)
      ? "eternityupbtnbought"
      : player.eternityPoints.gte("1e3000")
      ? "eternityupbtn"
      : "eternityupbtnlocked";
  } else {
  ...
  if (player.aarexModifications.ngp3c) {
    ...
    document.getElementById(
      "eter10"
    ).className = player.eternityUpgrades.includes(10)
      ? "eternityupbtnbought"
      : player.eternityPoints.gte("1e625")
      ? "eternityupbtn"
      : "eternityupbtnlocked";
    document.getElementById(
      "eter11"
    ).className = player.eternityUpgrades.includes(11)
      ? "eternityupbtnbought"
      : player.eternityPoints.gte("1e870")
      ? "eternityupbtn"
      : "eternityupbtnlocked";
    document.getElementById(
      "eter12"
    ).className = player.eternityUpgrades.includes(12)
      ? "eternityupbtnbought"
      : player.eternityPoints.gte("1e1350")
      ? "eternityupbtn"
      : "eternityupbtnlocked";
  } else {
...
function getEPCost(bought) {
  ...
  return Decimal.pow(
    bought > 481
      ? 1e3
      : bought > (player.aarexModifications.ngp3c ? 351 : 153)
      ? 500
      : bought > 58
      ? 100
      : 50,
...
document.getElementById("postinfi31").onclick = function () {
  if (
    ...
    if (player.tickSpeedMultDecrease > 2)
      ...
      document.getElementById("postinfi31").innerHTML =
        "Tickspeed cost multiplier increase<br>" +
        player.tickSpeedMultDecrease.toFixed(
          player.tickSpeedMultDecrease < 2 ? 2 : 0
        ) +
        "x";
    }
  }
...
document.getElementById("postinfi42").onclick = function () {
  if (
    ...
    if (player.dimensionMultDecrease > 3)
      ...
      document.getElementById("postinfi42").innerHTML =
        "Dimension cost multiplier increase<br>" +
        player.dimensionMultDecrease.toFixed(
          ECTimesCompleted("eterc6") % 5 > 0 ? 1 : 0
        ) +
        "x";
    }
  }
...
function updateInfCosts() {
  ...
  if (
    document.getElementById("ers_timestudies").style.display == "block" &&
    document.getElementById("eternitystore").style.display == "block"
  )
    updateERSTTDesc();
}
...
function toggleProductionTab() {
  ...
  player.aarexModifications.hideProductionTab = !player.aarexModifications
    .hideProductionTab;
  document.getElementById("hideProductionTab").textContent =
    (player.aarexModifications.hideProductionTab ? "Show" : "Hide") +
    " production tab";
...
function toggleAutoEternityTabShown() {
  ...
  player.aarexModifications.hideAutoEternity = !player.aarexModifications
    .hideAutoEternity;
  document.getElementById("hideAutoEternity").textContent =
    (player.aarexModifications.hideAutoEternity ? "Show" : "Hide") +
    " Auto-Eternity tab";
  if (document.getElementById("autoEternity").style.display == "block")
...
function toggleRepresentation() {
  // 0 == visible, 1 == not visible
  player.aarexModifications.hideRepresentation = !player.aarexModifications
    .hideRepresentation;
  document.getElementById("hideRepresentation").textContent =
    (player.aarexModifications.hideRepresentation ? "Show" : "Hide") +
    " antimatter representation";
}

function updateMilestones() {
  var moreUnlocked =
    tmp.ngp3 &&
    (player.dilation.upgrades.includes("ngpp3") ||
      quantumed ||
      (player.aarexModifications.ngp3c && nG(player.eternities, 1e9)));
  ...
  for (i = 0; i < (moreUnlocked ? 28 : 24); i++) {
    var name = "reward" + i;
    if (i > 23)
      document.getElementById("milestone" + i).textContent =
        shortenMoney(milestoneRequirements[i]) + " Eternities:";
  ...
  document.getElementById("reward2c").textContent = player.aarexModifications
    .ngp3c
    ? " (which also autobuys Replicated Condensers)"
    : "";
  document.getElementById("reward20c").textContent = player.aarexModifications
    .ngp3c
    ? ", and you start with 5 Replicated Condensers"
    : "";
  document.getElementById("mdmilestonesrow1a").style.display = moreUnlocked
    ? ""
    : "none";
  document.getElementById("mdmilestonesrow1b").style.display = moreUnlocked
    ? ""
    : "none";
  document.getElementById("mdmilestonesrow2a").style.display = moreUnlocked
    ? ""
    : "none";
  document.getElementById("mdmilestonesrow2b").style.display = moreUnlocked
    ? ""
    : "none";
}
  ...
  if (getEternitied() < 1) {
    if (canBuyIPMult()) {
      var toBuy = Math.max(
        Math.floor(
          player.infinityPoints
            .div(player.infMultCost)
            .times(ipMultCostIncrease - 1)
            .plus(1)
            .log(ipMultCostIncrease)
        ),
        1
      );
      var toSpend = Decimal.pow(ipMultCostIncrease, toBuy)
        .sub(1)
        .div(ipMultCostIncrease - 1)
        .times(player.infMultCost)
        .round();
      ...
      player.infMult = player.infMult.times(
        Decimal.pow(getIPMultPower(), toBuy)
      );
      player.infMultCost = player.infMultCost.times(
        Decimal.pow(ipMultCostIncrease, toBuy)
      );
    }
  } else {
    player.infMultBuyer = !player.infMultBuyer;
    document.getElementById("infmultbuyer").textContent =
      "Autobuy IP mult O" + (player.infMultBuyer ? "N" : "FF");
  }
}
...
function toggleEternityConf() {
  ...
  document.getElementById("eternityconf").textContent =
    "Eternity confirmation: O" + (player.options.eternityconfirm ? "N" : "FF");
}

function toggleDilaConf() {
  player.aarexModifications.dilationConf = !player.aarexModifications
    .dilationConf;
  document.getElementById("dilationConfirmBtn").textContent =
    "Dilation confirmation: O" +
    (player.aarexModifications.dilationConf ? "N" : "FF");
}
...
function getSaveLayout(id) {
  return (
    ...
    "</b><div id='save_" +
    id +
    "_desc'></div><button class='storebtn' onclick='overwrite_save(" +
    id +
    ")'>Save</button><button class='storebtn' onclick='change_save(" +
    id +
    ")'>Load</button><button class='storebtn' onclick='rename_save(" +
    id +
    ")'>Rename</button><button class='storebtn' onclick='export_save(" +
    id +
    ")'>Export</button><button class='storebtn' onclick='import_save(" +
    id +
    ")'>Import</button><button class='storebtn' onclick='move(" +
    id +
    ",-1)'>Move up</button><button class='storebtn' onclick='move(" +
    id +
    ",1)'>Move down</button><button class='storebtn' onclick='delete_save(" +
    id +
    ")'>Delete</button>"
  );
}
  ...
  try {
    ...
    if (temp.exdilation) {
      msg +=
        temp.meta ||
        exp != "" ||
        temp.aarexModifications.newGameMinusVersion ||
        temp.galacticSacrifice
          ? "Ud"
          : " Update";
      ...
      msg += exp;
      if (
        !temp.aarexModifications.nguspV &&
        !temp.aarexModifications.ngudpV &&
        temp.meta
      )
        msg += "+";
    ...
    if (temp.aarexModifications.ngmX > 3)
      msg += "-" + temp.aarexModifications.ngmX;
    else if (temp.galacticSacrifice)
      msg += "--" + (temp.tickspeedBoosts != undefined ? "-" : "");
    else if (temp.aarexModifications.newGameMinusVersion) msg += "-";
    var ex = temp.aarexModifications.ngexV;
    if (temp.boughtDims)
      msg = msg != "" || ex ? "ER" + msg : "Eternity Respecced";
    else if (temp.singularity)
      msg = msg != "" || ex ? "IR" + msg : "Infinity Respecced";
    else msg = "NG" + msg;
    if (ex) msg = msg == "NG" ? "Expert Mode" : msg + "Ex";
    if (temp.galacticSacrifice && temp.aarexModifications.newGameMinusVersion)
      msg += ", NG-";
    if (
      (temp.exdilation || temp.meta) &&
      !temp.aarexModifications.newGamePlusVersion &&
      !temp.aarexModifications.ngp3c
    )
      msg += ", no NG+ features";
    msg =
      (msg == "NG" ? "" : msg + "<br>") +
      (isSaveCurrent
        ? "Selected<br>"
        : "Played for " + timeDisplayShort(temp.totalTimePlayed) + "<br>");
    ...
    if (isSaveGhostified) {
      if (temp.achievements.includes("ng3p91")) {
        ...
        msg +=
          "Bosonic Antimatter: " +
          shorten(new Decimal(temp.ghostify.bl.am)) +
          ", Higgs Bosons: " +
          shortenDimensions(new Decimal(data.higgs));
        ...
        msg +=
          ...
          shorten(new Decimal(temp.ghostify.bl.am)) +
          ", W+ Bosons: " +
          shortenDimensions(new Decimal(data.wpb)) +
          ", W- Bosons: " +
          shortenDimensions(new Decimal(data.wnb)) +
          ", Z Bosons: " +
          shortenDimensions(new Decimal(data.zb));
        ...
        msg +=
          "Ghostly Photons: " +
          shortenDimensions(new Decimal(data.amount)) +
          ", Dark Matter: " +
          shortenDimensions(new Decimal(data.darkMatter)) +
          ", Ghostly Rays: " +
          shortenDimensions(new Decimal(data.ghostlyRays)) +
          ", Lights: " +
          getFullExpansion(lights) +
          ", Light Empowerments: " +
          getFullExpansion(data.enpowerments);
      } else
        msg +=
          "Ghost Particles: " +
          shortenDimensions(new Decimal(temp.ghostify.ghostParticles)) +
          ", Neutrinos: " +
          shortenDimensions(
            Decimal.add(
              temp.ghostify.neutrinos.electron,
              temp.ghostify.neutrinos.mu
            )
              .add(temp.ghostify.neutrinos.tau)
              .round()
          );
      ...
      if (!temp.masterystudies) msg += "Endgame of NG++";
        ...
        msg +=
          "Total antimatter in Big Rips: " +
          shortenDimensions(new Decimal(temp.quantum.bigRip.totalAntimatter)) +
          ", Space Shards: " +
          shortenDimensions(new Decimal(temp.quantum.bigRip.spaceShards)) +
          (temp.achievements.includes("ng3p55")
            ? ", Eternal Matter: " +
              shortenDimensions(
                new Decimal(temp.quantum.breakEternity.eternalMatter)
              )
            : "");
      else {
        msg +=
          "Quarks: " +
          shortenDimensions(
            Decimal.add(temp.quantum.quarks, temp.quantum.usedQuarks.r)
              .add(temp.quantum.usedQuarks.g)
              .add(temp.quantum.usedQuarks.b)
          );
        if (temp.quantum.gluons.rg)
          msg +=
            ", Gluons: " +
            shortenDimensions(
              Decimal.add(temp.quantum.gluons.rg, temp.quantum.gluons.gb).add(
                temp.quantum.gluons.br
              )
            );
        if (temp.masterystudies.includes("d13"))
          msg +=
            ", Quark Spins: " +
            shortenDimensions(
              Decimal.add(temp.quantum.tod.r.spin, temp.quantum.tod.g.spin).add(
                temp.quantum.tod.b.spin
              )
            );
        else if (temp.masterystudies.includes("d12"))
          msg +=
            ", Preon charge: " +
            shortenDimensions(new Decimal(temp.quantum.nanofield.charge)) +
            ", Preon energy: " +
            shortenDimensions(new Decimal(temp.quantum.nanofield.energy)) +
            ", Preon anti-energy: " +
            shortenDimensions(new Decimal(temp.quantum.nanofield.antienergy)) +
            ", Nanofield Rewards: " +
            getFullExpansion(temp.quantum.nanofield.rewards);
        else if (temp.masterystudies.includes("d10"))
          msg +=
            ", Replicants: " +
            shortenDimensions(getTotalReplicants(temp)) +
            ", Worker replicants: " +
            shortenDimensions(getTotalWorkers(temp));
        else if (temp.masterystudies.includes("d9"))
          msg +=
            ", Paired challenges: " + temp.quantum.pairedChallenges.completed;
          ...
          if (typeof temp.quantum.challenges == "number")
            ...
            for (c = 1; c < 9; c++)
              if (temp.quantum.challenges[c]) completions++;
          ...
          if (temp.masterystudies.includes("d7"))
            msg +=
              ", Electrons: " +
              shortenDimensions(temp.quantum.electrons.amount);
        }
      }
    } else if (temp.exdilation == undefined ? false : temp.blackhole.unl) {
      var tempstart =
        "Eternity points: " +
        shortenDimensions(new Decimal(temp.eternityPoints));
      var tempend =
        ", Black hole power: " +
        shortenMoney(new Decimal(temp.blackhole.power));
      if (temp.exdilation.times > 0)
        msg +=
          tempstart +
          tempend +
          ", Ex-dilation: " +
          shortenDimensions(new Decimal(temp.exdilation.unspent));
      else
        msg +=
          tempstart +
          ", Dilated time: " +
          shortenMoney(new Decimal(temp.dilation.dilatedTime)) +
          ", Banked infinities: " +
          getFullExpansion(temp.infinitiedBank) +
          ", Replicanti: " +
          shortenMoney(new Decimal(temp.replicanti.amount)) +
          tempend;
    } else if (temp.dilation ? temp.dilation.studies.includes(1) : false) {
      var temp2 =
        "Tachyon particles: " +
        shortenMoney(new Decimal(temp.dilation.totalTachyonParticles)) +
        ", Dilated time: " +
        shortenMoney(new Decimal(temp.dilation.dilatedTime));
      if (temp.dilation.studies.includes(6))
        temp2 +=
          ", Best meta-antimatter: " +
          shortenMoney(new Decimal(temp.meta.bestAntimatter)) +
          ", Meta-dimension shifts/boosts: " +
          temp.meta.resets;
      else if (!temp.dilation.studies.includes(5))
        temp2 =
          "Time Theorems: " + shortenMoney(getTotalTT(temp)) + ", " + temp2;
      else if (!temp.dilation.upgrades.includes(10))
        temp2 =
          "Eternity points: " +
          shortenDimensions(temp.eternityPoints) +
          ", " +
          temp2;
      msg += temp2;
    } else {
      var totalChallengeCompletions = temp.aarexModifications
        .newGameMinusVersion
        ? -6
        : 0;
      for (ec = 1; ec < 13; ec++)
        totalChallengeCompletions += temp.eternityChalls["eterc" + ec]
          ? temp.eternityChalls["eterc" + ec]
          : 0;
      if (totalChallengeCompletions > 0) {
        msg +=
          "Time Theorems: " +
          getFullExpansion(getTotalTT(temp)) +
          ", Challenge completions: " +
          totalChallengeCompletions;
      } else if (
        temp.eternities >
        (temp.aarexModifications.newGameMinusVersion ? -20 : 0)
      )
        msg +=
          "Eternity points: " +
          shortenDimensions(new Decimal(temp.eternityPoints)) +
          ", Eternities: " +
          temp.eternities.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") +
          ", Time Theorems: " +
          getFullExpansion(getTotalTT(temp));
      else if (temp.achievements.includes("r51")) {
        msg +=
          "Antimatter: " +
          shortenMoney(new Decimal(temp.money)) +
          ", Infinity points: " +
          shortenDimensions(new Decimal(temp.infinityPoints));
        if (temp.postChallUnlocked > 0 && !temp.replicanti.unlocked) {
          var totalChallengeCompletions = 0;
          for (ic = 1; ic < 13; ic++)
            totalChallengeCompletions += temp.challenges.includes("postc" + ic)
              ? 1
              : 0;
        ...
        msg +=
          ...
          shortenDimensions(new Decimal(temp.infinityPoints)) +
          ", Infinities: " +
          temp.infinitied.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") +
          ", Challenge completions: " +
          temp.challenges.length;
      else if (
        temp.galacticSacrifice ? temp.galacticSacrifice.times > 0 : false
      )
        msg +=
          "Antimatter: " +
          shortenMoney(new Decimal(temp.money)) +
          ", Galaxy points: " +
          shortenDimensions(new Decimal(temp.galacticSacrifice.galaxyPoints));
      else
        msg +=
          "Antimatter: " +
          shortenMoney(new Decimal(temp.money)) +
          ", Dimension Shifts/Boosts: " +
          temp.resets +
          ((
            temp.tickspeedBoosts != undefined
              ? temp.resets > 0 ||
                temp.tickspeedBoosts > 0 ||
                temp.galaxies > 0 ||
                temp.infinitied > 0 ||
                temp.eternities != 0 ||
                isSaveQuantumed
    ...
    document.getElementById("save_" + saveId + "_title").textContent = temp
      .aarexModifications.save_name
      ? temp.aarexModifications.save_name
      : "Save #" + placement;
  } catch (_) {
    var msg = "New game";
  }
...
function toggle_mod(id) {
  ...
  // Change submod
  var subMode =
    ((modes[id] || 0) + 1) % ((hasSubMod && modSubNames[id].length) || 2);
  if (id == "ngp" && subMode == 2 && (!(modes.ngpp >= 2) || !metaSave.ngp4))
    subMode = 0;
  else if (id == "ngpp" && subMode == 1 && (modes.ngud || modes.ngex))
    subMode = 2;
  else if (id == "ngpp" && subMode == 3 && modes.ngex) subMode = 0;
  else if (id == "arrows" && subMode == 2 && modes.rs) subMode = 0;
  modes[id] = subMode;
  // Update displays
  document.getElementById(id + "Btn").textContent = `${modFullNames[id]}: ${
    hasSubMod ? modSubNames[id][subMode] : subMode ? "ON" : "OFF"
  }`;
  if (id == "ngex" && subMode) {
    modes.ngp = 0;
    modes.aau = 0;
  ...
  if (
    (id == "ngp" ||
      id == "aau" ||
      ((id == "ngpp" || (id == "ngud" && subMode > 1)) && !metaSave.ngp3ex)) &&
    subMode
  ) {
    modes.ngex = 0;
  ...
  if (
    ((id == "ngud" && ((subMode > 1 && !modes.ngpp) || modes.ngpp == 1)) ||
      (id == "ngex" &&
        (modes.ngpp == 1 || modes.ngpp == 3) &&
        metaSave.ngp3ex)) &&
    subMode
  ) {
    modes.ngpp = 2;
  ...
  if (
    ((id == "ngpp" || id == "ngud") && !subMode) ||
    ((id == "rs" || (id == "ngex" && !metaSave.ngp3ex)) && subMode)
  ) {
    if (modes.ngud > 1) {
      modes.ngud = 1;
...
function toggleOfflineProgress() {
  player.aarexModifications.offlineProgress = !player.aarexModifications
    .offlineProgress;
  document.getElementById("offlineProgress").textContent =
    "Offline progress: O" +
    (player.aarexModifications.offlineProgress ? "N" : "FF");
}
...
function showNextModeMessage() {
  if (ngModeMessages.length > 0) {
    ...
    document.getElementById("welcomeMessage").innerHTML =
      ngModeMessages[ngModeMessages.length - 1];
    ngModeMessages.pop();
...
function import_save(type) {
  ...
  if (
    sha512_256(save_data.replace(/\s/g, "").toUpperCase()) ===
      "8aaff3cdcf68f6392b172ee9924a22918451e511c8e60b120f09e2c16d4e26ac" &&
    !tmp.ngp3l
  )
    giveAchievement("The Forbidden Layer");
  if (
    ...
    sha512_256(save_data) ===
    "4f82333af895f5c89e6b2082a7dab5a35b964614e74908961fe915cefca1c6d0"
  ) {
    player.options.theme = "S6";
    player.options.secretThemeKey = save_data;
    setTheme(player.options.theme);
  } else {
    var decoded_save_data = JSON.parse(
      atob(save_data, function (k, v) {
...
function reset_game() {
  if (!forceHardReset)
    if (!confirm("Do you really want to erase all your progress in this save?"))
      return;
  clearInterval(gameLoopIntervalId);
...
function getEPGainBase() {
  ...
  if (player.timestudy.studies.includes(112) && player.aarexModifications.ngp3c)
    base /= 2;
  if (player.timestudy.studies.includes(113) && player.aarexModifications.ngp3c)
    base /= 1.5;
  return base;
}
...
function gainedEternityPoints() {
  let uEPM =
    player.dilation.upgrades.includes("ngp3c7") &&
    player.aarexModifications.ngp3c;
  var ret = Decimal.pow(
    5,
    player.infinityPoints.plus(gainedInfinityPoints()).e / getEPGainBase() - 0.7
  ).times(uEPM ? 1 : player.epmult);
  ...
  if (player.timestudy.studies.includes(121))
    ret = ret.times(
      (253 - averageEp.dividedBy(player.epmult).dividedBy(10).min(248).max(3)) /
        5
    );
  ...
  if (
    player.galacticSacrifice !== undefined &&
    player.galacticSacrifice.upgrades.includes(51)
  )
    ret = ret.times(galMults.u51());
  if (tmp.ngp3) {
    if (player.quantum.bigRip.active) {
      if (isBigRipUpgradeActive(6))
  ...
  if (tmp.be && tmp.ngp3c) ret = ret.times(getBreakUpgMult(7));
  if (player.timestudy.studies.includes(172) && player.aarexModifications.ngp3c)
    ret = ret.times(ts172Eff());
...
function updateNotationOption() {
  var notationMsg =
    "Notation: " +
    (player.options.notation == "Emojis" ? "Cancer" : player.options.notation);
  var commasMsg =
    (player.options.commas == "Emojis" ? "Cancer" : player.options.commas) +
    " on exponents";
  document.getElementById("notation").innerHTML =
    "<p style='font-size:15px'>Notations</p>" +
    notationMsg +
    "<br>" +
    commasMsg;
  document.getElementById("chosenNotation").textContent =
    player.options.notation == "AF5LN"
      ? "Notation: Aarex's Funny 5-letter Notation"
      : notationMsg;
  document.getElementById("chosenCommas").textContent =
    player.options.commas == "AF5LN"
...
function onNotationChange() {
  document.getElementsByClassName("hideInMorse").display =
    player.options.notation == "Morse code" ||
    player.options.notation == "Spazzy"
      ? "none"
      : "";
  ...
  if (tmp.ngp3) {
    ...
    document.getElementById("bpc68").textContent = shortenMoney(
      tmp.qu.pairedChallenges.pc68best
    );
    ...
    if (!player.ghostify.ghostlyPhotons.unl)
      document.getElementById("gphUnl").textContent =
        "To unlock Ghostly Photons, you need to get " +
        shortenCosts(Decimal.pow(10, tmp.ngp3c ? 3.5e9 : 6e9)) +
        " antimatter while your universe is Big Ripped first.";
  ...
  document.getElementById("epmult").innerHTML =
    ...
    shortenDimensions(player.epmultCost) +
    " EP";
  document.getElementById("achmultlabel").textContent =
    "Current achievement multiplier on each Dimension: " +
    shortenMoney(player.achPow) +
    "x";
  if (
    player.achievements.includes("ng3p18") ||
    player.achievements.includes("ng3p37")
  ) {
    document.getElementById("bestTP").textContent =
      "Your best" +
      (ghostified ? "" : " ever") +
      " Tachyon particles" +
      (ghostified ? " in this Ghostify" : "") +
      " was " +
      shorten(player.dilation.bestTP) +
      ".";
    setAndMaybeShow(
      "bestTPOverGhostifies",
      ghostified,
      '"Your best-ever Tachyon particles was "+shorten(player.dilation.bestTPOverGhostifies)+"."'
    );
  }
}
...
document.getElementById("notation").onclick = function () {
  ...
  if (!notationMenuDone) {
    ...
    row.innerHTML =
      "<button class='storebtn' style='width:160px; height: 40px' onclick='switchCommas(0)'>Commas on exponents</button>";
    row = commasTable.insertRow(1);
    row.innerHTML =
      "<button class='storebtn' style='width:160px; height: 40px' onclick='switchCommas(1)'>Same notation on exponents</button>";

    for (n = 0; n < notationArray.length; n++) {
      var name = notationArray[n] == "Emojis" ? "Cancer" : notationArray[n];
      row = notationsTable.insertRow(n);
      row.innerHTML =
        "<button class='storebtn' id='select" +
        name +
        "' style='width:160px; height: 40px' onclick='switchNotation(" +
        n +
        ")'>Select " +
        name +
        "</button>";
      ...
      row.innerHTML =
        "<button class='storebtn' id='selectCommas" +
        name +
        "' style='width:160px; height: 40px' onclick='switchCommas(" +
        (n + 2) +
        ")'>" +
        name +
        " on exponents</button>";
      if (n > 18) {
        ...
        row.innerHTML =
          "<button class='storebtn' id='selectSub" +
          name +
          "' style='width:160px; height: 40px' onclick='switchSubNotation(" +
          n +
          ")'>Select " +
          name +
          "</button>";
        ...
        row.innerHTML =
          "<button class='storebtn' style='width:160px; height: 40px' onclick='switchSubNotation(" +
          n +
          ")'>Select " +
          name +
          "</button>";
    ...
    document
      .getElementById("selectAAS")
      .setAttribute("ach-tooltip", "Select Aarex's Abbreviation System");
    document
      .getElementById("selectCommasAAS")
      .setAttribute("ach-tooltip", "Aarex's Abbreviation System on exponents");
    document
      .getElementById("selectAF5LN")
      .setAttribute("ach-tooltip", "Select Aarex's Funny 5-letter Notation");
    document
      .getElementById("selectCommasAF5LN")
      .setAttribute(
        "ach-tooltip",
        "Aarex's Funny 5-letter Notation on exponents"
      );
...
function openNotationOptions() {
  if (document.getElementById("mainnotationoptions1").style.display == "") {
    ...
    document.getElementById("significantDigits").value = player.options
      .scientific.significantDigits
      ? player.options.scientific.significantDigits
      : 0;
    document.getElementById("logBase").value = player.options.logarithm.base;
    document.getElementById("tetrationBase").value =
      player.options.tetration.base;
    document.getElementById("maxLength").value = player.options.psi.chars;
    document.getElementById("maxArguments").value = Math.min(
      player.options.psi.args,
      4
    );
    document.getElementById("maxLetters").value = player.options.psi.maxletters;
    document.getElementById("psiSide").textContent =
      "Non-first arguments on " +
      (player.options.psi.side == "r" ? "right" : "left") +
      " side";
    var letters = [null, "E", "F", "G", "H"];
    document.getElementById("psiLetter").textContent = player.options.psi
      .letter[0]
      ? "Force " + letters[player.options.psi.letter[0]]
      : "Automatically choose letter";
    document.getElementById("chosenSubNotation").textContent =
      "Sub-notation: " +
      (player.options.spazzy.subNotation == "Emojis"
        ? "Cancer"
        : player.options.spazzy.subNotation);
    document.getElementById("useHyphens").checked =
      player.options.aas.useHyphens;
...
function showHideFooter(toggle) {
  ...
  document.getElementById("footerBtn").textContent =
    (player.aarexModifications.noFooter ? "Show" : "Hide") + " footer";
  document.documentElement.style.setProperty(
    "--footer",
    player.aarexModifications.noFooter ? "none" : ""
  );
}

document.getElementById("newsbtn").onclick = function (force) {
  player.options.newsHidden = !player.options.newsHidden;
  document.getElementById("newsbtn").textContent =
    (player.options.newsHidden ? "Show" : "Hide") + " news ticker";
  document.getElementById("game").style.display = player.options.newsHidden
    ? "none"
    : "block";
...
function resetDimensions() {
  ...
  if (inNC(10) || player.currentChallenge == "postc1")
    costs = [10, 100, 100, 500, 2500, 2e4, 2e5, 4e6];
...
function calcSacrificeBoost() {
  ...
  if (
    player.challenges.includes("postc2") ||
    (player.tickspeedBoosts != undefined && player.currentChallenge == "postc2")
  ) {
    pow = 0.01;
    ...
    if (player.achievements.includes("r32"))
      pow += player.tickspeedBoosts != undefined ? 2 : 0.2;
    if (player.achievements.includes("r57"))
      pow += player.boughtDims ? 0.3 : 0.2; //this upgrade was too OP lol
    if (player.infinityUpgradesRespecced) pow *= getInfUpgPow(5);
    ret = Decimal.pow(
      Math.max(player.firstAmount.e / 10.0, 1) /
        Math.max(player.sacrificed.e / 10.0, 1),
      pow
    ).max(1);
  } else
    ret = player.firstAmount
      .pow(0.05)
      .dividedBy(
        player.sacrificed
          .pow(player.aarexModifications.ngmX > 3 ? 0.05 : 0.04)
          .max(1)
      )
      .max(1);
  if (player.boughtDims)
    ret = ret.pow(
      1 + Math.log(1 + Math.log(1 + player.timestudy.ers_studies[1] / 5))
    );
  if (player.aarexModifications.ngp3c) {
  ...
  if (player.boughtDims)
    ret = ret.pow(
      1 +
        Math.log(
          1 +
            Math.log(1 + (player.timestudy.ers_studies[1] + (next ? 1 : 0)) / 5)
        )
    );
  if (player.aarexModifications.ngp3c) {
    if (player.resets >= 6) ret = ret.pow(1.5);
...
function sacrifice(auto = false) {
  ...
  if (inNC(11) && (tmp.sacPow.gte(maxPower) || player.chall11Pow.gte(maxPower)))
    return false;
  ...
  if (!inNC(11)) {
    if (
      (inNC(7) ||
        player.currentChallenge == "postcngm3_3" ||
        player.pSac !== undefined) &&
...
function updateAutobuyers() {
  ...
  autoSacrifice.interval = player.galacticSacrifice
    ? 1.5e4
  ...
  if (
    (player.challenges.includes("postc2") ||
      player.challenges.includes("challenge13") ||
      player.challenges.includes("challenge16")) &&
  ...
  if (
    player.challenges.includes("challenge14") &&
    player.autobuyers[12] == 13
  ) {
  ...
  if (
    player.challenges.includes("challenge15") &&
    player.autobuyers[13] == 14
  ) {
    player.autobuyers[13] = autoTickspeedBoost;
    document.getElementById("autoBuyerTickspeedBoost").style.display =
      "inline-block";
  ...
  var intervalUnits = player.infinityUpgrades.includes("autoBuyerUpgrade")
    ? 1 / 2000
    : 1 / 1000;
  for (var tier = 1; tier <= 8; ++tier) {
    document.getElementById("interval" + tier).textContent =
      "Current interval: " +
      (player.autobuyers[tier - 1].interval * intervalUnits).toFixed(2) +
      " seconds";
  }
  document.getElementById("intervalTickSpeed").textContent =
    "Current interval: " +
    (player.autobuyers[8].interval * intervalUnits).toFixed(2) +
    " seconds";
  document.getElementById("intervalDimBoost").textContent =
    "Current interval: " +
    (player.autobuyers[9].interval * intervalUnits).toFixed(2) +
    " seconds";
  document.getElementById("intervalGalaxies").textContent =
    "Current interval: " +
    (player.autobuyers[10].interval * intervalUnits).toFixed(2) +
    " seconds";
  document.getElementById("intervalInf").textContent =
    "Current interval: " +
    (player.autobuyers[11].interval * intervalUnits).toFixed(2) +
    " seconds";
  document.getElementById("intervalSac").textContent =
    "Current interval: " +
    (player.autoSacrifice.interval * intervalUnits).toFixed(2) +
    " seconds";
  if (player.galacticSacrifice)
    document.getElementById("intervalGalSac").textContent =
      "Current interval: " +
      (player.autobuyers[12].interval * intervalUnits).toFixed(2) +
      " seconds";
  if (player.tickspeedBoosts != undefined)
    document.getElementById("intervalTickspeedBoost").textContent =
      "Current interval: " +
      (player.autobuyers[13].interval * intervalUnits).toFixed(2) +
      " seconds";
  if (player.aarexModifications.ngmX > 3)
    document.getElementById("intervalTDBoost").textContent =
      "Current interval: " +
      (player.autobuyers[14].interval * intervalUnits).toFixed(2) +
      " seconds";
  ...
  if (canBreakInfinity()) {
    ...
    document.getElementById("abletobreak").textContent =
      "You need to " +
      (player.aarexModifications.ngexV
        ? "complete all Normal Challenges"
        : "get Automated Big Crunch interval to 0.1") +
      " to be able to break infinity";
  ...
  if (player.autoSacrifice.interval <= 100) {
    ...
    if (player.galacticSacrifice || player.infinityUpgradesRespecced)
      maxedAutobuy++;
  }
  if (player.galacticSacrifice)
  ...
  document.getElementById("buyerBtnTickSpeed").innerHTML =
    "40% smaller interval <br>Cost: " + player.autobuyers[8].cost + currencyEnd;
  document.getElementById("buyerBtnDimBoost").innerHTML =
    "40% smaller interval <br>Cost: " + player.autobuyers[9].cost + currencyEnd;
  document.getElementById("buyerBtnGalaxies").innerHTML =
    "40% smaller interval <br>Cost: " +
    player.autobuyers[10].cost +
    currencyEnd;
  document.getElementById("buyerBtnInf").innerHTML =
    "40% smaller interval <br>Cost: " + player.autobuyers[11].cost + " IP";
  document.getElementById("buyerBtnSac").innerHTML =
    "40% smaller interval <br>Cost: " + player.autoSacrifice.cost + currencyEnd;
  if (player.autobuyers[9].interval <= 100) {
    if (player.infinityUpgradesRespecced && !player.autobuyers[9].bulkBought)
      document.getElementById("buyerBtnDimBoost").innerHTML =
        "Buy bulk feature<br>Cost: " + shortenCosts(1e4) + currencyEnd;
    else document.getElementById("buyerBtnDimBoost").style.display = "none";
    maxedAutobuy++;
  }
  if (player.autobuyers[10].interval <= 100) {
    if (player.infinityUpgradesRespecced && !player.autobuyers[10].bulkBought)
      document.getElementById("buyerBtnGalaxies").innerHTML =
        "Buy bulk feature<br>Cost: " + shortenCosts(1e4) + currencyEnd;
  ...
  if (player.galacticSacrifice)
    document.getElementById("buyerBtnGalSac").innerHTML =
      "40% smaller interval <br>Cost: " +
      player.autobuyers[12].cost +
      currencyEnd;
  if (player.tickspeedBoosts != undefined)
    document.getElementById("buyerBtnTickspeedBoost").innerHTML =
      "40% smaller interval <br>Cost: " +
      player.autobuyers[13].cost +
      currencyEnd;
  if (player.aarexModifications.ngmX > 3)
    document.getElementById("buyerBtnTDBoost").innerHTML =
      "40% smaller interval <br>Cost: " +
      player.autobuyers[14].cost +
      currencyEnd;
  ...
  if (tmp.ngp3) {
    if (player.achievements.includes("ng3p52"))
      document.getElementById("autoEterToggle").textContent = player
        .eternityBuyer.isOn
        ? "Disable"
        : "Enable";
    player.eternityBuyer.dilationMode = document.getElementById(
      "dilatedeternityison"
    ).checked;
    if (player.achievements.includes("ng3p52"))
      document.getElementById("autoDilToggle").textContent = player
        .eternityBuyer.dilationMode
        ? "Disable"
        : "Enable";
    player.eternityBuyer.dilationPerAmount = Math.max(
      parseInt(document.getElementById("prioritydil").value),
      2
    );
    if (
      player.eternityBuyer.isOn &&
      player.eternityBuyer.dilationMode &&
      player.eternityBuyer.statBeforeDilation >=
        player.eternityBuyer.dilationPerAmount &&
      !player.eternityBuyer.slowStopped &&
      player.eternityBuyer.dilMode == "amount"
    ) {
    ...
    if (tmp.qu)
      if (tmp.qu.autobuyer)
        tmp.qu.autobuyer.enabled = document.getElementById(
          "quantumison"
        ).checked;
  }
  priorityOrder();
  ...
  for (i = 0; i < 9; i++)
    if (player.autobuyers[i] % 1 !== 0 && player.autobuyers[i].isOn)
      ndAutobuyersUsed++;
  document.getElementById("maxall").style.display =
    ndAutobuyersUsed > 8 && player.challenges.includes("postc8") ? "none" : "";
}
...
function updatePriorities() {
  ...
  if (
    ...
    parseInt(
      fromValue(document.getElementById("priority14").value).toString()
    ) === 69 ||
    parseInt(document.getElementById("overGalaxiesTickspeedBoost").value) ===
      69 ||
    parseInt(document.getElementById("bulkTickBoost").value) === 69 ||
    parseInt(
      fromValue(document.getElementById("priority15").value).toString()
    ) === 69 ||
    parseInt(document.getElementById("prioritydil").value) === 69 ||
    parseInt(
      fromValue(document.getElementById("priorityquantum").value).toString()
    ) === 69
  )
  ...
  if (!isNaN(break_infinity_js ? infValue : infValue.l))
    ...
    document.getElementById("priority12").value.toLowerCase() == "max"
  )
    player.autobuyers[11].priority = document.getElementById(
      "priority12"
    ).value;
  ...
  if (player.autobuyers[13] != undefined) {
    player.autobuyers[13].priority = parseInt(
      document.getElementById("priority15").value
    );
    player.overXGalaxiesTickspeedBoost = parseInt(
      document.getElementById("overGalaxiesTickspeedBoost").value
    );
    player.autobuyers[13].bulk = Math.floor(
      Math.max(parseFloat(document.getElementById("bulkTickBoost").value), 1)
    );
    player.autobuyers[13].bulk = isNaN(player.autobuyers[13].bulk)
      ? 1
      : player.autobuyers[13].bulk;
  }
  if (player.autobuyers[14] != undefined) {
    player.autobuyers[14].priority = parseInt(
      document.getElementById("priority16").value
    );
    player.autobuyers[14].overXGals = parseInt(
      document.getElementById("overGalaxiesTDBoost").value
    );
  }
  ...
  if (!isNaN(break_infinity_js ? eterValue : eterValue.l)) {
    ...
    if (player.achievements.includes("ng3p52"))
      document.getElementById("autoEterValue").value = document.getElementById(
        "priority13"
      ).value;
  }
  if (tmp.ngp3) {
    ...
    const quantumValue = fromValue(
      document.getElementById("priorityquantum").value
    );
    if (
      !isNaN(break_infinity_js ? quantumValue : quantumValue.l) &&
      tmp.qu.autobuyer
    )
...
function updateCheckBoxes() {
  for (var i = 0; i < player.autobuyers.length; i++) {
    if (player.autobuyers[i] % 1 !== 0) {
      ...
      document.getElementById(id).checked = player.autobuyers[i].isOn
        ? "true"
        : "";
    }
  }
  ...
  if (tmp.ngp3) {
    document.getElementById("dilatedeternityison").checked =
      player.eternityBuyer.dilationMode;
    if (tmp.qu)
      if (tmp.qu.autobuyer)
        document.getElementById("quantumison").checked =
          tmp.qu.autobuyer.enabled;
...
function updateHotkeys() {
  let html =
    "Hotkeys: 1-8 for buy 10 dimension, shift+1-8 for buy 1 dimension, T to buy max tickspeed, shift+T to buy one tickspeed, M for max all,<br>S for sacrifice";
  ...
  if (!player.achievements.includes("ng3p51")) {
    ...
    if (player.aarexModifications.ngmX >= 4)
      html += ", N for time dimension boost";
    html += ", G for galaxy";
  }
  html +=
    ", C for crunch, A for toggle autobuyers, R for replicanti galaxies, E for eternity";
  ...
  if (player.achievements.includes("ng3p45"))
  ...
  if (player.boughtDims)
    html +=
      "<br>You can hold shift while buying time studies to buy all up until that point, see each study's number, and save study trees.";
...
var challNames = [
  null,
  null,
  "Second Dimension Autobuyer Challenge",
  ...
  "Automated Dimension Boosts Challenge",
  "Automated Galaxies Challenge",
  "Automated Big Crunches Challenge",
  "Automated Dimensional Sacrifice Challenge",
  "Automated Galactic Sacrifice Challenge",
  "Automated Tickspeed Boosts Challenge",
  "Automated Time Dimension Boosts Challenge"
];
...
function updateChallengeTimes() {
  for (c = 2; c < 17; c++)
    setAndMaybeShow(
      "challengetime" + c,
      player.challengeTimes[challOrder[c] - 2] < 600 * 60 * 24 * 31,
      '"' +
        challNames[c] +
        ' time record: "+timeDisplayShort(player.challengeTimes[' +
        (challOrder[c] - 2) +
        "], false, 3)"
    );
  var temp = 0;
  ...
  for (var i = 0; i < player.challengeTimes.length; i++)
    if (
      player.challenges.includes("challenge" + (i + 2)) &&
      player.challengeTimes[i] < 600 * 60 * 24 * 31
    ) {
  ...
  setAndMaybeShow(
    "challengetimesum",
    tempcounter > 1,
    '"Sum of completed challenge time records is "+timeDisplayShort(' +
      temp +
      ", false, 3)"
  );
  document.getElementById("challengetimesbtn").style.display =
    tempcounter > 0 ? "inline-block" : "none";

  var temp = 0;
  var tempcounter = 0;
  for (var i = 0; i < 16; i++) {
    setAndMaybeShow(
      "infchallengetime" + (i + 1),
      player.infchallengeTimes[i] < 600 * 60 * 24 * 31,
      '"Infinity Challenge ' +
        (i + 1) +
        ' time record: "+timeDisplayShort(player.infchallengeTimes[' +
        i +
        "], false, 3)"
    );
  ...
  setAndMaybeShow(
    "infchallengetimesum",
    tempcounter > 1,
    '"Sum of completed infinity challenge time records is "+timeDisplayShort(' +
      temp +
      ", false, 3)"
  );
...
function updateEterChallengeTimes() {
  ...
  for (var i = 1; i < 15; i++) {
    setAndMaybeShow(
      "eterchallengetime" + i,
      player.aarexModifications.eternityChallRecords[i],
      '"Eternity Challenge ' +
        i +
        ' time record: "+timeDisplayShort(player.aarexModifications.eternityChallRecords[' +
        i +
        "], false, 3)"
    );
  ...
  document.getElementById("eterchallengesbtn").style.display =
    tempcounter > 0 ? "inline-block" : "none";
  setAndMaybeShow(
    "eterchallengetimesum",
    tempcounter > 1,
    '"Sum of completed eternity challenge time records is "+timeDisplayShort(' +
      temp +
      ", false, 3)"
  );
}
...
function updateLastTenEternities() {
  ...
  for (var i = 0; i < 10; i++) {
    if (player.lastTenEternities[i][1].gt(0)) {
      ...
      var unit = player.lastTenEternities[i][2]
        ? player.lastTenEternities[i][2] == "b"
          ? "EM"
          : player.lastTenEternities[i][2] == "d2"
          ? "TP"
          : "EP"
        : "EP";
      ...
      msg =
        "The Eternity " +
        (i == 0 ? "1 eternity" : i + 1 + " eternities") +
        " ago took " +
        timeDisplayShort(player.lastTenEternities[i][0], false, 3);
      if (player.lastTenEternities[i][2]) {
        if (player.lastTenEternities[i][2] == "b")
          msg += " while it was broken";
  ...
  if (listed > 1) {
    ...
    document.getElementById("averageEternityRun").textContent =
      "Average time of the last " +
      listed +
      " Eternities: " +
      timeDisplayShort(tempTime, false, 3) +
      " | Average EP gain: " +
...
function getLimit() {
  ...
  return Decimal.pow(
    Number.MAX_VALUE,
    1 + player.infinityUpgradesRespecced[3] / 2
  );
}
...
function doCrunchReplicantiAutobuy() {
  if (
    ...
    var bought = Math.min(
      Math.max(
        Math.floor(
          player.infinityPoints.div(player.replicanti.chanceCost).log(1e15) + 1
        ),
        0
      ),
      tmp.ngp3 && player.masterystudies.includes("t265")
        ? 1 / 0
        : 100 - Math.round(player.replicanti.chance * 100)
    );
    player.replicanti.chance =
      Math.round(player.replicanti.chance * 100 + bought) / 100;
    player.replicanti.chanceCost = player.replicanti.chanceCost.times(
      Decimal.pow(1e15, bought)
    );
  }
...
function doIRCrunchResetStuff() {
  ...
  if (player.dimtechs.respec) {
    ...
    player.infinityPoints = player.infinityPoints.add(
      Decimal.pow(5, total).sub(1).div(4).round().times(1e95)
    );
...
function doGPUpgCrunchUpdating(g11MultShown) {
  var showg11Mult =
    player.infinitied > 0 || player.eternities !== 0 || quantumed;
  if (player.galacticSacrifice && showg11Mult != g11MultShown) {
    document.getElementById("galaxy11").innerHTML =
      "Normal" +
      (player.aarexModifications.ngmX > 3 ? " and Time D" : " d") +
      "imensions are " +
      (showg11Mult
        ? "cheaper based on your infinitied stat.<br>Currently: <span id='galspan11'></span>x"
        : "99% cheaper.") +
      "<br>Cost: 1 GP";
    document.getElementById("galaxy15").innerHTML =
      "Normal and Time Dimensions produce " +
      (showg11Mult
        ? "faster based on your infinitied stat.<br>Currently: <span id='galspan15'></span>x"
        : "100x faster") +
      ".<br>Cost: 1 GP";
  }
}
...
function doAfterResetCrunchStuff(g11MultShown) {
  document.getElementById("challengeconfirmation").style.display =
    "inline-block";
  ...
  if (
    ...
    (tmp.ngp3l || !player.achievements.includes("ng3p67"))
  )
...
function bigCrunch(autoed) {
  ...
  if (
    (!player.achievements.includes("r55") ||
      (player.options.animations.bigCrunch === "always" && !autoed)) &&
    isEmptiness &&
    implosionCheck === 0 &&
  ...
  if (player.aarexModifications.ngmX >= 4)
    if (player.galacticSacrifice.chall) {
      ...
      if (player.challengeTimes[challNumber - 2] > player.thisInfinityTime)
        player.challengeTimes[challNumber - 2] = player.thisInfinityTime;
    }
  if (
    player.currentChallenge.includes("post") &&
  ...
  if (isEmptiness) {
    ...
    if (player.eternities > 0 || quantumed)
      document.getElementById("eternitystorebtn").style.display =
        "inline-block";
    if (quantumed)
...
function doCheckECCompletionStuff() {
  ...
  if (player.currentEternityChall !== "") {
    if (tmp.ngp3c && tmp.qu)
      if (
        tmp.qu.bigRip.active &&
        player.currentEternityChall === "eterc14" &&
        player.eternityChalls.eterc14 == 5
      )
        giveAchievement("Really?");
    ...
    if (player.eternityChalls[player.currentEternityChall] === undefined) {
      ...
      player.aarexModifications.eternityChallRecords[
        player.eternityChallUnlocked
      ] === undefined
    )
      player.aarexModifications.eternityChallRecords[
        player.eternityChallUnlocked
    ...
    if (
      ...
      player.achievements.includes("ng3p51")
    ) {
    ...
    if (
      tmp.ngp3
        ? tmp.qu.autoEC &&
          player.eternityChalls[player.currentEternityChall] < 5
        : false
    ) {
      if (player.etercreq > 12)
        player.timestudy.theorem = nA(
          player.timestudy.theorem,
          masteryStudies.costs.ec[player.etercreq]
        );
      else
        player.timestudy.theorem = nA(
          player.timestudy.theorem,
          [0, 30, 35, 40, 70, 130, 85, 115, 115, 415, 550, 1, 1][
            player.etercreq
          ]
        );
      player.eternityChallUnlocked = 0;
...
function eternity(force, auto, presetLoad, dilated) {
  ...
  if (
    ...
    player.dimensionMultDecrease < 4
  )
    player.dimensionMultDecrease = Math.max(
      parseFloat((player.dimensionMultDecrease - 0.2).toFixed(1)),
      2
    );
  if (!GUBought("gb4"))
    if (
      (player.currentEternityChall == "eterc11" ||
        (player.currentEternityChall == "eterc12" && ghostified)) &&
      ECTimesCompleted("eterc11") < 5
    )
      player.tickSpeedMultDecrease = Math.max(
        parseFloat((player.tickSpeedMultDecrease - 0.07).toFixed(2)),
        1.65
      );
  ...
  if (
    ...
    player.currentEternityChall == "eterc11" &&
    inQC(6) &&
    (tmp.ngp3c ? inQC("8c") : inQC(8)) &&
    inQCModifier("ad") &&
    player.infinityPoints.e >= 15500
  )
  ...
  temp = [];
  if (
    gainedEternityPoints().gte(player.eternityPoints) &&
    player.eternityPoints.gte("1e1185") &&
    (tmp.ngp3 ? player.dilation.active && player.quantum.bigRip.active : false)
  )
  ...
  if (player.dilation.active)
    array = [
      player.thisEternity,
      getDilGain().sub(player.dilation.totalTachyonParticles).max(0),
      "d2"
    ];
  else if (player.currentEternityChall != "")
    array.push(player.eternityChallUnlocked);
  else if (tmp.be) {
    tmp.qu.breakEternity.eternalMatter = tmp.qu.breakEternity.eternalMatter.add(
      getEMGain()
    );
  ...
  if (
    ...
    if (gain.gte(player.dilation.totalTachyonParticles)) {
      if (
        player.dilation.totalTachyonParticles.gt(0) &&
        gain.div(player.dilation.totalTachyonParticles).lt(2)
      )
  ...
  if (tmp.ngp3 && player.dilation.studies.includes(1) && !force)
    if (player.eternityBuyer.isOn && player.eternityBuyer.dilationMode) {
      ...
      if (
        player.eternityBuyer.dilMode == "upgrades" &&
        player.eternityBuyer.tpUpgraded
      ) {
        startDilatedEternity(true);
        return;
      }
  ...
  updateBankedEter();
  if (player.tickspeedBoosts != undefined) player.tickspeedBoosts = 0;
  player.infinityPoints = new Decimal(
    player.achievements.includes("r104") ? 2e25 : 0
  );
  ...
  if (presetLoad === undefined) {
    ...
    if (pData !== undefined ? pData.on : false) {
      ...
      if (dilated && dilActive) {
        ...
        player.masterystudies.includes("t291") &&
        player.eternityPoints.log10() >= oldEP.log10() * 1.01 &&
        !dilated2 &&
        grindActive
      ) {
        if (pData.selected > -1) {
        ...
        if (
          ...
          document.getElementById(
            "eternitiesLeft"
          ).textContent = getFullExpansion(pData.left);
        }
      }
    }
  }
  ...
  extraReplGalaxies = 0;
  if (dilated || tmp.ngp3l || !player.achievements.includes("ng3p67"))
  ...
  document.getElementById("totaltickgained").textContent =
    "You've gained " +
    getFullExpansion(player.totalTickGained) +
    " tickspeed upgrades.";
  hideDimensions();
  tmp.tickUpdate = true;
...
function resetReplicantiUpgrades() {
  let keepPartial =
    ...
    player.dilation.upgrades.includes("ngpp3") &&
    getEternitied() >= 2e10;
  player.replicanti.chance = keepPartial
    ? Math.min(player.replicanti.chance, 1)
    : 0.01;
  player.replicanti.interval = keepPartial
    ? Math.max(
        player.replicanti.interval,
        player.timestudy.studies.includes(22) ? 1 : 50
      )
    : 1000;
  player.replicanti.gal = 0;
  player.replicanti.chanceCost = Decimal.pow(
    1e15,
    player.replicanti.chance * 100
  ).times(
    player.galacticSacrifice !== undefined &&
      player.tickspeedBoosts == undefined
      ? 1e75
  ...
  player.replicanti.intervalCost = Decimal.pow(
    1e10,
    Math.round(Math.log10(1000 / player.replicanti.interval) / -Math.log10(0.9))
  ).times(
    player.galacticSacrifice !== undefined &&
      player.tickspeedBoosts == undefined
      ? 1e80
  ...
  player.replicanti.galCost = new Decimal(
    player.galacticSacrifice !== undefined &&
    player.tickspeedBoosts == undefined
      ? 1e110
      : 1e170
...
function gainEternitiedStat() {
  ...
  if (ghostified) {
    ...
    if (hasNU(9) && !tmp.ngp3c)
      ret = nM(ret, tmp.qu.bigRip.spaceShards.max(1).pow(0.1));
  }
  if (player.timestudy.studies.includes(34) && player.aarexModifications.ngp3c)
    ret = nM(ret, 10);
  if (player.timestudy.studies.includes(35) && player.aarexModifications.ngp3c)
    ret = nM(ret, ts35Eff());
  ...
  if (player.aarexModifications.ngp3c & (exp > 0))
    ret = nM(
      ret,
      Decimal.pow(player.dilation.tachyonParticles.plus(1).log10() + 1, exp)
    );
  ...
  switch (idx) {
    case 1:
      if (
        getEternitied() >=
        ecStarts[1] +
          (ECTimesCompleted("eterc1") ? ECTimesCompleted("eterc1") : 0) *
            ecMults[1]
      )
        return true;
      break;
    ...
    case 2:
      if (
        ...
        ecStarts[2] + ECTimesCompleted("eterc2") * ecMults[2]
      )
        return true;
      break;
    ...
    case 3:
      if (
        player.eightAmount.gte(
          ecStarts[3] + ECTimesCompleted("eterc3") * ecMults[3]
        )
      )
        return true;
      break;
    ...
    case 4:
      if (
        ecStarts[4] + ECTimesCompleted("eterc4") * ecMults[4] <=
        getInfinitied()
      )
        return true;
      break;
    ...
    case 5:
      if (
        ecStarts[5] + ECTimesCompleted("eterc5") * ecMults[5] <=
        player.galaxies
      )
        return true;
      break;
    ...
    case 6:
      if (
        ecStarts[6] + ECTimesCompleted("eterc6") * ecMults[6] <=
    ...
    case 7:
      if (
        player.money.gte(
          new Decimal(ecStarts[7]).times(
            new Decimal(ecMults[7]).pow(ECTimesCompleted("eterc7"))
          )
        )
      )
        return true;
    ...
    case 8:
      if (
        player.infinityPoints.gte(
          new Decimal(ecStarts[8]).times(
            new Decimal(ecMults[8]).pow(ECTimesCompleted("eterc8"))
          )
        )
      )
        return true;
    ...
    case 9:
      if (
        player.infinityPower.gte(
          new Decimal(ecStarts[9]).times(
            new Decimal(ecMults[9]).pow(ECTimesCompleted("eterc9"))
          )
        )
      )
        return true;
    ...
    case 10:
      if (
        player.eternityPoints.gte(
          new Decimal(ecStarts[10]).times(
            new Decimal(ecMults[10]).pow(ECTimesCompleted("eterc10"))
          )
        )
      )
        return true;
...
function updateECUnlockButtons() {
  for (let ecnum = 1; ecnum <= 12; ecnum++) {
    ...
    if (canUnlockECFromNum(ecnum))
      document.getElementById(s).className = "eternitychallengestudy";
...
function getECGoal(x) {
  ...
  if (x == "ec13" && !tmp.ngp3l)
    exp += 600000 * Math.max(completions - 2, 0) * (completions - 3, 0);
...
function getECReward(x, alt = false) {
  ...
  if (x == 1)
    return Math.pow(
      Math.max(player.thisEternity * 10, 1),
      (0.3 + c * 0.05) * (m2 || pc ? 5 : 1)
    );
  if (x == 2) {
  ...
  if (x == 4)
    return player.infinityPoints
      .max(1)
      .pow((m2 ? 0.4 : 0.003) + c * (m2 ? 0.2 : 0.002))
      .pow(pc ? 5 : 1)
      .min(m2 || pc ? 1 / 0 : 1e200);
  if (x == 5) return c * 5;
  if (x == 8) {
  ...
  if (x == 10)
    return Decimal.pow(getInfinitied(), m2 ? 2 : 0.9)
      .times(Math.pow(c, pc ? 10 : 1) * (m2 ? 0.02 : 0.000002))
      .add(1)
  ...
  if (x == 11 && pc)
    return Math.sqrt(
      Math.log10(
        (Math.pow(c, 2) *
          (player.totalTickGained + (Math.max(c, 1) - 1) * 5e4)) /
          1e5 +
          1
      ) /
        (4 - c / 2) +
  ...
  if (x == 12) return 1 - c * (m2 ? 0.06 : 0.008);
  if (x == 13 && !alt) {
    var data = {
  ...
  if (x == 13 && alt) {
    ...
    if (Decimal.gte(chance, 5e3))
      chance = Decimal.pow(
        10,
        Math.pow(Decimal.log10(chance) * Math.pow(Math.log10(5e3), 4), 0.2)
      );
    let eff = Decimal.pow(
      10,
      Math.pow(Decimal.mul(chance, c).plus(1).log10(), 2)
    )
      .pow(6e3 + 2e3 * c)
      .times(Decimal.add(tmp.rep ? tmp.rep.chance : 0, 1));
...
function startEternityChallenge(n) {
  if (
    ...
    parseInt(n) != player.eternityChallUnlocked
  )
    return;
  if (player.options.challConf)
    if (
      !confirm(
        "You will start over with just your time studies, eternity upgrades and achievements. You need to reach a set IP goal with special conditions."
      )
    )
      return;
...
function canQuickBigRip() {
  ...
  if (
    tmp.ngp3 &&
    player.masterystudies.includes("d14") &&
    inQC(0) &&
    tmp.qu.electrons.amount >= 62500
  ) {
...
function replicantiShopABRun() {
  if (
    ...
    var maxCost = (tmp.ngp3 ? player.masterystudies.includes("t265") : false)
      ? 1 / 0
      : new Decimal("1e1620").div(
          player.aarexModifications.ngmX == 2 ? 1e60 : 1
        );
    var bought = Math.max(
      Math.floor(
        player.infinityPoints
          .min(maxCost)
          .div(player.replicanti.chanceCost)
          .log(1e15) + 1
      ),
      0
    );
    if (!tmp.ngp3 || !player.masterystudies.includes("t265"))
      bought = Math.min(bought, 100 - chance);
...
function failedEC12Check() {
  if (
    player.currentEternityChall == "eterc12" &&
    player.thisEternity >= getEC12TimeLimit()
  ) {
    setTimeout(exitChallenge, 500);
    onChallengeFail();
  }
...
function updateNGpp17Reward() {
  document.getElementById(
    "epmultauto"
  ).style.display = player.achievements.includes("ngpp17") ? "" : "none";
  for (i = 1; i < 9; i++)
    document.getElementById(
      "td" + i + "auto"
    ).style.visibility = player.achievements.includes("ngpp17")
      ? "visible"
      : "hidden";
  document.getElementById(
    "togglealltimedims"
...
function updateNGpp16Reward() {
  document.getElementById("replicantibulkmodetoggle").style.display =
    player.achievements.includes("ngpp16") ||
    (player.aarexModifications.ngp3c && player.eternityUpgrades.includes(6))
      ? "inline-block"
      : "none";
}
  ...
  if (speedrunMilestonesReached > notifyId) {
    $.notify(
      "You have unlocked the " +
        timeDisplayShort(speedrunMilestones[notifyId + 1] * 10) +
        " speedrun milestone! " +
        [
          "You now start with 20,000 eternities when going Quantum",
          "You unlocked the Time Theorem autobuyer",
          "You now start with all Eternity Challenges completed and\nEternity Upgrades bought",
          "You now start with Dilation unlocked",
          "You unlocked the Dilation option for the Eternity autobuyer",
          "You now start with all dilation studies and\nnon-rebuyable dilation upgrades before Meta Dimensions unlocked, except the passive TT gen upgrade",
          "You unlocked the First Meta Dimension autobuyer",
          "You unlocked the Second Meta Dimension autobuyer",
          "You unlocked the Third Meta Dimension autobuyer",
          "You unlocked the Fourth Meta Dimension autobuyer",
          "You unlocked the Fifth Meta Dimension autobuyer, and you now keep Time Studies and the passive TT gen upgrade",
          "You unlocked the Sixth Meta Dimension autobuyer",
          "You unlocked the Seventh Meta Dimension autobuyer",
          "You unlocked Eighth Meta Dimension autobuyer, and\nall non-rebuyable dilation upgrades",
          "You unlocked the Meta-Dimension Boost autobuyer",
          "You now keep your Mastery Studies",
          "All Meta Dimensions are instantly available for purchase on Quantum",
          "You now start with " + shortenCosts(1e13) + " eternities",
          "You now start with " +
            shortenCosts(1e25) +
            " meta-antimatter on reset",
          "You can now turn on automatic replicated galaxies regardless of your second Time Study split path",
          "Rebuyable Dilation upgrade and Meta Dimension autobuyers are 3x faster",
          "You now start with " +
            shortenCosts(1e100) +
            " dilated time on Quantum, and dilated time only resets on Quantum",
          "You unlocked the Quantum autobuyer",
          "You now keep your Replicanti on Eternity",
          "You unlocked the manual mode for the Eternity autobuyer and got the sacrifice galaxy autobuyer",
          "Your rebuyable dilation upgrade autobuyer can now buy the maximum upgrades possible",
          "You now can buy max Meta-Dimension Boosts and start with 4 Meta-Dimension Boosts",
          "From now on, you can gain banked infinities based on your post-crunch infinitied stat"
        ][notifyId] +
        ".",
      "success"
    );
...
function notifyGhostifyMilestones() {
  ...
  if (player.ghostify.milestones > notifyId2) {
    $.notify(
      "You became a ghost in at most " +
        getFullExpansion(tmp.bm[notifyId2]) +
        " quantumed stat! " +
        [
          "You now start with all Speedrun Milestones and all " +
            shorten(Number.MAX_VALUE) +
            " QK assignation features unlocked, all Paired Challenges completed, all Big Rip upgrades bought, Nanofield is 2x faster until you reach 16 rewards, and you get quarks based on your best MA this quantum",
          "From now on, colored quarks do not cancel, you keep your gluon upgrades, you can quick Big Rip, and completing an Eternity Challenge doesn't respec your Time Studies.",
          "You now keep your Electron upgrades",
          "From now on, Quantum doesn't reset your Tachyon particles unless you are in a QC, unstabilizing quarks doesn't lose your colored quarks, and you start with 5 of 1st upgrades of each Tree Branch",
          "From now on, Quantum doesn't reset your Meta-Dimension Boosts unless you are in a QC or undoing Big Rip",
          "From now on, Quantum doesn't reset your normal replicants unless you are in a QC or undoing Big Rip",
          "You now start with 10 worker replicants and Ghostify now doesn't reset Neutrinos.",
          "You are now gaining ^0.5 amount of quarks, ^0.5 amount of gluons, and 1% of Space Shards gained on Quantum per second.",
          "You now start with 10 Emperor Dimensions of each tier up to the second tier" +
            (player.aarexModifications.ngudpV
              ? ", and from now on, start Big Rips with the 3rd row of Eternity Upgrades"
              : ""),
          "You now start with 10 Emperor Dimensions of each tier up to the fourth tier",
          "You now start with 10 Emperor Dimensions of each tier up to the sixth tier, and the IP multiplier no longer costs IP",
          "You now start with 10 of each Emperor Dimension",
          "You now start with 16 Nanofield rewards",
          "You now start with " +
            shortenCosts(1e25) +
            " quark spins, and Branches are faster based on your spins",
          "You now start with Break Eternity unlocked and all Break Eternity upgrades bought and generate 1% of Eternal Matter gained on Eternity per second",
          "From now on, you gain 1% of quarks you will gain per second and you keep your Tachyon particles on Quantum and Ghostify outside of Big Rip."
        ][notifyId2] +
        ".",
      "success"
    );
...
function dilationStuffABTick() {
  ...
  document.getElementById("dilUpgsauto").style.display = canAutoUpgs
    ? ""
    : "none";
  document.getElementById("distribEx").style.display =
    player.achievements.includes("ngud14") &&
    player.aarexModifications.nguspV !== undefined
      ? ""
      : "none";
  ...
  document.getElementById(
    "dilationTabbtn"
  ).style.display = player.dilation.studies.includes(1) ? "table-cell" : "none";
  document.getElementById("blackHoleTabbtn").style.display =
    player.dilation.studies.includes(1) && player.exdilation != undefined
      ? "table-cell"
      : "none";
...
function inEasierMode() {
  return (
    player.aarexModifications.newGameMult ||
    player.aarexModifications.newGameExpVersion ||
    player.aarexModifications.ngudpV ||
    player.aarexModifications.ngumuV ||
    player.aarexModifications.nguepV ||
    player.aarexModifications.aau
  );
}
...
function doGhostifyUnlockStuff() {
  ...
  document.getElementById("welcomeMessage").innerHTML =
    "You are finally able to complete " +
    (tmp.ngp3c ? "QC6+7+8" : "PC6+8") +
    " in Big Rip! However, because of the unstability of this universe, the only way to go further is to become a ghost. This allows you to pass Big Rip universes and unlock new stuff in Ghostify in exchange for everything that you have. Therefore, this is the sixth layer of NG+3.";
}
...
function doReachAMGoalStuff(chall) {
  ...
  document.getElementById("welcomeMessage").innerHTML =
    "You reached the antimatter goal (" +
    shorten(Decimal.pow(10, getQCGoal())) +
    "), but you didn't reach the meta-antimatter goal yet! Get " +
    shorten(getQuantumReq()) +
    " meta-antimatter" +
    (player.quantum.bigRip.active
      ? " and then you can become a ghost!"
      : " and then go Quantum to complete your challenge!");
...
function doQuantumUnlockStuff() {
  ...
  document.getElementById("welcomeMessage").innerHTML =
    ...
    shorten(getQuantumReq()) +
    " MA and completed EC14 for the first time! This allows you to go Quantum (the 5th layer), giving you a quark in exchange for everything up to this point, which can be used to get more powerful upgrades. This allows you to get gigantic numbers!";
}
...
function doNGP3UnlockStuff() {
  ...
  if (
    chall &&
    player.money.gt(Decimal.pow(10, getQCGoal())) &&
    MAbool &&
    DONEbool &&
    TIMEbool &&
    !tmp.ngp3c
  ...
  if (!player.ghostify.reached && tmp.qu.bigRip.active)
    if (
      tmp.qu.bigRip.bestThisRun.gte(Decimal.pow(10, getQCGoal(undefined, true)))
    ) {
  ...
  if (
    player.eternityPoints.gte(
      tmp.ngp3c
        ? ghostified
          ? NGP3C_BE_REQ.div(1e50)
          : NGP3C_BE_REQ
        : "1e1200"
    ) &&
    tmp.qu.bigRip.active &&
    !tmp.qu.breakEternity.unlocked
  )
    doBreakEternityUnlockStuff();
  if (
    player.money.gte(Decimal.pow(10, tmp.ngp3c ? 3.5e9 : 6e9)) &&
    tmp.qu.bigRip.active &&
    !player.ghostify.ghostlyPhotons.unl
  )
    doPhotonsUnlockStuff();
  if (canUnlockBosonicLab() && !player.ghostify.wzb.unl) doBosonsUnlockStuff();
  if (canUnlockWZB() && tmp.ngp3c && !player.ghostify.wzb.WZBUNL)
    doWZBUnlockStuff();
  if (canUnlockBosonicUpgrades() && tmp.ngp3c && !player.ghostify.bl.UPGSUNL)
    doBosonicUpgUnlockStuff();
...
function updateResetTierButtons() {
  var postBreak =
    getEternitied() != 0 ||
    (player.infinityPoints.gte(Number.MAX_VALUE) &&
      player.infDimensionsUnlocked[7]) ||
    player.break;
  var preQuantumEnd = quantumed;
  var canBigRip = canQuickBigRip();

  if (!preQuantumEnd && player.meta !== undefined)
    preQuantumEnd = isQuantumReached();
  var haveBlock =
    (player.galacticSacrifice != undefined && postBreak) ||
    (player.pSac != undefined && player.infinitied > 0) ||
    preQuantumEnd;
  var haveBlock2 =
    player.pSac !== undefined &&
    (ghostified || player.achievements.includes("ng3p51") || canBigRip);

  document.getElementById("acndbtn").style.display =
    player.aarexModifications.ngp3c && !isEmptiness ? "" : "none";

  if (player.pSac !== undefined) {
    document.getElementById("px").className = haveBlock2
      ? "PX"
      : postBreak
      ? "GHP"
      : player.infinitied > 0
  ...
  document.getElementById("pSacPos").className = haveBlock2
    ? "pSacPos"
    : postBreak
    ? "ghostifyPos"
    : player.infinitied > 0
  ...
  if (
    player.galacticSacrifice === undefined
      ...
      : (postBreak ||
          player.infinitied > 0 ||
          player.galacticSacrifice.times > 0) &&
        !isEmptiness
  ) {
    document.getElementById("galaxyPoints2").style.display = "";
    document.getElementById("galaxyPoints2").className = preQuantumEnd
      ? "GP"
      : postBreak
      ? "QK"
      : "EP";
  } else document.getElementById("galaxyPoints2").style.display = "none";
  document.getElementById("sacpos").className = preQuantumEnd
    ? "sacpos"
    : postBreak
    ? "quantumpos"
    : "eterpos";

  document.getElementById("bigcrunch").parentElement.style.top = haveBlock2
    ? "259px"
    : haveBlock
    ? "139px"
    : "19px";
  document.getElementById("quantumBlock").style.display = haveBlock
    ? ""
    : "none";
  document.getElementById("quantumBlock").style.height = haveBlock2
    ? "240px"
    : "120px";
  ...
  document.getElementById("quantumbtn").className = bigRipped
    ? "bigripbtn"
    : "quantumbtn";
  document.getElementById("quantumbtn").style.display =
    showQuantumBtn || bigRipped ? "" : "none";
  document.getElementById("bigripbtn").style.display = canBigRip ? "" : "none";

  document.getElementById("ghostparticles").style.display = ghostified
    ? ""
    : "none";
  if (ghostified) {
    document.getElementById("GHPAmount").textContent = shortenDimensions(
      player.ghostify.ghostParticles
    );
    var showQuantumed =
      player.ghostify.times > 0 && player.ghostify.milestones < 16;
    document.getElementById("quantumedBM").style.display = showQuantumed
      ? ""
      : "none";
    if (showQuantumed)
      document.getElementById(
        "quantumedBMAmount"
      ).textContent = getFullExpansion(tmp.qu.times);
  }
  document.getElementById("ghostifybtn").style.display =
    showQuantumBtn && bigRipped ? "" : "none";
}

function updateOrderGoals() {
  document.getElementById("ngp3c_pc6_desc").textContent = player
    .aarexModifications.ngp3c
    ? ", and OS_IP_1 & OS_IP_2 are 75% weaker"
    : "";
  if (order)
    for (var i = 0; i < order.length; i++)
      document.getElementById(order[i] + "goal").textContent =
        "Goal: " + shortenCosts(getGoal(order[i]));
}
...
function givePerSecondNeuts() {
  ...
  player.ghostify.neutrinos.electron = player.ghostify.neutrinos.electron.plus(
    n
  );
...
function doPerSecondNGP3Stuff() {
  ...
  if (isAutoGhostActive(9) && tmp.qu.replicants.quantumFood > 0) {
    for (d = 1; d < 9; d++)
      if (
        canFeedReplicant(d) &&
        (d == tmp.qu.replicants.limitDim ||
          (!tmp.eds[d + 1].perm && tmp.eds[d].workers.lt(11)))
      ) {
        feedReplicant(d, true);
        break;
      }
  }
  if (tmp.ngp3c && player.condensed.autoEmp && player.ghostify.milestones > 7)
    for (let i = 1; i <= 8; i++) maxEmpCondense(i);
  ...
  if (player.achievements.includes("ng3p43"))
    if (player.ghostify.milestones >= 8) maxUpgradeColorDimPower();
  if (tmp.qu.autoOptions.assignQK && player.ghostify.milestones > 7)
    assignAll(true);
  givePerSecondNeuts();
...
function checkGluonRounding() {
  ...
  if (player.quantum.gluons.rg.lt(101))
    player.quantum.gluons.rg = player.quantum.gluons.rg.round();
  if (player.quantum.gluons.gb.lt(101))
    player.quantum.gluons.gb = player.quantum.gluons.gb.round();
  if (player.quantum.gluons.br.lt(101))
    player.quantum.gluons.br = player.quantum.gluons.br.round();
...
setInterval(function () {
  ...
  if (!tmp.ngp3 || !quantumed)
    if (player.infinityPoints.lt(100))
      player.infinityPoints = player.infinityPoints.round();
  checkGluonRounding();
}, 1000);
...
function updateEPminpeak(diff, type) {
  if (type == "EP") {
    ...
    var gainedPoints = getDilGain()
      .sub(player.dilation.totalTachyonParticles)
      .max(0);
  ...
  var currentEPmin = (EPminpeakType == "logarithm"
    ? new Decimal(Math.max(0, newLog - Math.max(oldPoints.log10(), 0)))
    : gainedPoints
  ).dividedBy(minutes);
  if (
    currentEPmin.gt(EPminpeak) &&
    player.infinityPoints.gte(Number.MAX_VALUE)
  ) {
...
function checkMatter(diff) {
  ...
  if (haveET) {
    ...
    if (player.matter.lt(player.money)) {
      ...
      if (player.matter.gte(player.money))
        player.pSac.dims.extraTime +=
          player.matter.div(player.money).log(tmp.mv) / 10;
  ...
  if (
    player.matter.pow(20).gt(player.money) &&
    (player.currentChallenge == "postc7" ||
      (inQC(6) && !player.achievements.includes("ng3p34")))
  ) {
...
function passiveIPupdating(diff) {
  if (player.infinityUpgrades.includes("passiveGen"))
    player.partInfinityPoint += (diff / player.bestInfinityTime) * 10;
...
function passiveInfinitiesUpdating(diff) {
  ...
  if (
    ...
    if (
      player.timestudy.studies.includes(35) &&
      player.aarexModifications.ngp3c
    )
      gain = nM(gain, getInfinitiedGain());
  ...
  player.partInfinitied = Math.max(
    Math.min(new Decimal(tempPA || 0).toNumber(), 1),
    0
  );
}
...
function passiveEternitiesUpdating(diff) {
  if (!tmp.ngp3c) return;
  if (hasNU(5)) {
    player.eternities = nA(
      player.eternities,
      nM(gainEternitiedStat(), diff / 100)
    );
  }
}
...
function infinityRespeccedDMUpdating(diff) {
  ...
  player.singularity.darkMatter = player.singularity.darkMatter.add(
    getDarkMatterPerSecond().times(diff)
  );
  ...
  if (player.singularity.darkMatter.gte(getNextDiscounts())) {
    ...
    for (d = 1; d < 9; d++) {
      var name = TIER_NAMES[d];
      player[name + "Cost"] = player[name + "Cost"].div(
        getDiscountMultiplier("dim" + d)
      );
    }
    player.tickSpeedCost = player.tickSpeedCost.div(
      getDiscountMultiplier("tick")
    );
  }
}
...
function changingDecimalSystemUpdating() {
  ...
  if (break_infinity_js) {
    ...
    clearInterval(gameLoopIntervalId);
    alert(
      "You have reached the limit of break_infinity.js. In order for the game to continue functioning, the game will switch the library to logarithmica_numerus.js, requiring a game reload, but will have a higher limit. You cannot change libraries for this save again in the future."
    );
    player.aarexModifications.breakInfinity = !player.aarexModifications
      .breakInfinity;
    save_game(true);
    document.location.reload(true);
    return;
...
function requiredInfinityUpdating(diff) {
  if (tmp.ri) return;
  if (player.infinityUpgradesRespecced != undefined)
    infinityRespeccedDMUpdating(diff);
  ...
  for (
    let tier =
      (inQC(1)
        ...
        ? 3
        : inNC(4) || player.currentChallenge == "postc1"
        ? 5
        : 7) -
      (inNC(7) ||
      player.currentChallenge == "postcngm3_3" ||
    ...
    player[name + "Amount"] = player[name + "Amount"].plus(
      getDimensionProductionPerSecond(
        tier +
          (inNC(7) ||
          player.currentChallenge == "postcngm3_3" ||
          inQC(4) ||
  ...
  if (player.totalmoney.gt("1e9000000000000000"))
    changingDecimalSystemUpdating();
  tmp.ri =
    player.money.gte(getLimit()) &&
    ((player.currentChallenge != "" &&
      player.money.gte(player.challengeTarget)) ||
      !onPostBreak());
}
...
function normalChallPowerUpdating(diff) {
  ...
  if (inNC(3) || player.matter.gte(1))
    player.chall3Pow = player.chall3Pow
      .times(Decimal.pow(1.00038, diff))
      .min(1e200);
...
function incrementParadoxUpdating(diff) {
  if (player.pSac !== undefined) {
    //Paradox Power
    player.pSac.dims.power = player.pSac.dims.power.add(
      getPDProduction(1).times(diff)
    );
    for (var t = 1; t < 7; t++) {
      if (!isDimUnlocked(t + 2)) break;
      player.pSac.dims[t].amount = player.pSac.dims[t].amount.add(
        getPDProduction(t + 2).times(diff)
      );
    }
  }
}
...
function dimensionButtonDisplayUpdating() {
  document.getElementById("pdtabbtn").style.display = pSacrificed()
    ? ""
    : "none";
  document.getElementById("tdtabbtn").style.display =
    (player.eternities > 0 ||
      quantumed ||
      player.aarexModifications.ngmX > 3) &&
    (!inQC(8) || tmp.be)
  ...
  document.getElementById(
    "mdtabbtn"
  ).style.display = player.dilation.studies.includes(6) ? "" : "none";
}
...
function ghostifyAutomationUpdating(diff) {
  if (ghostified && isAutoGhostsSafe) {
    ...
    for (var c = 1; c <= 3; c++) {
      ...
      if (
        isAutoGhostActive(c) &&
        tmp.qu.usedQuarks[shorthand].gt(0) &&
        tmp.qu.tod[shorthand].quarks.eq(0)
      )
        unstableQuarks(shorthand);
      if (
        isAutoGhostActive(12) &&
        getUnstableGain(shorthand)
          .max(tmp.qu.tod[shorthand].quarks)
          .gte(Decimal.pow(10, Math.pow(2, 50)))
      ) {
        unstableQuarks(shorthand);
    ...
    if (isAutoGhostActive(11)) {
      ...
      var preonGenerate;
      if (tmp.ngp3c) {
        let gain = Decimal.min(
          1,
          tmp.qu.replicants.quarks.div(getQuarkLossProduction())
        ).times(getQuarkChargeProduction());
        preonGenerate =
          gain.gte(tmp.qu.nanofield.charge.times((ag.pc || 0) / 100)) &&
          tmp.qu.replicants.quarks.div(getQuarkLossProduction()).gte(0.01);
      } else
        preonGenerate =
          tmp.qu.replicants.quarks.div(getGatherRate().total).gte(ag.pw) &&
          tmp.qu.replicants.quarks.div(getQuarkLossProduction()).gte(ag.lw) &&
          tmp.qu.nanofield.charge.div(ag.cw).lt(1);
    ...
    if (isAutoGhostActive(15))
      if (
        tmp.qu.bigRip.active &&
        getGHPGain().gte(player.ghostify.automatorGhosts[15].a)
      )
        ghostify(true);
    if (tmp.ngp3l) return;
    if (isAutoGhostActive(16)) maxNeutrinoMult();
    let constantElectronUpdates =
      tmp.ngp3c && tmp.hm
        ? player.ghostify.hb.unl &&
          tmp.hm.electrons &&
          Decimal.gt(player.ghostify.hb.masses.electrons || 0, 0)
        : false;
    if (isAutoGhostActive(18)) {
      ...
      for (var u = 1; u <= 4; u++) {
        ...
        if (added > 0)
          tmp.qu.electrons.mult += added * getElectronUpgIncrease(u);
      }
      if (addedTotal > 0 && !constantElectronUpdates) updateElectrons(true);
      if (tmp.ngp3c) elecCondense(true);
    }
    if (isAutoGhostActive(19))
      maxAllBosonicEnchants(
        ((player.ghostify.automatorGhosts[19].a || 0) * diff) / 100
      );
...
function updateBosonicWatts(keepSpd = true) {
  ...
  if (!keepSpd)
    tmp.bEn.totalLvlEffect = tmp.ngp3c
      ? getBENTotalLevelEffect()
      : new Decimal(1);
  var wattGained = Math.max(
    getBosonicWattGain(),
    keepSpd ? data.watt : data.watt - wattSub
  );
  var wattMult = getBosonicSpeedMult();
  var effectiveWattGain = wattGained * wattMult;
  data.speed = Math.max(
    Math.min(
      effectiveWattGain + (effectiveWattGain - data.speed) * 2,
      effectiveWattGain
    ),
    keepSpd ? data.speed : 0
  );
...
function ghostlyPhotonsUpdating(diff) {
  ...
  data.ghostlyRays = data.ghostlyRays
    .add(getGHRProduction().times(diff))
    .min(getGHRCap());
  for (var c = 0; c < 8; c++) {
    if (data.ghostlyRays.gte(getLightThreshold(c))) {
      data.lights[c] += Math.floor(
        data.ghostlyRays
          .div(getLightThreshold(c))
          .log(getLightThresholdIncrease(c)) + 1
      );
...
function nanofieldProducingChargeUpdating(diff) {
  ...
  if (toSub.eq(0)) {
    ...
    document.getElementById("produceQuarkCharge").innerHTML =
      "Start production of preon charge.<br>(You will not get preons when you do this.)";
  } else {
    tmp.qu.replicants.quarks = tmp.qu.replicants.quarks.sub(toSub);
    tmp.qu.nanofield.charge = tmp.qu.nanofield.charge.add(
      toSub.div(loss).times(rate)
    );
  }
}
...
function nanofieldUpdating(diff) {
  ...
  var toAddAE = AErate.times(diff).min(
    getQuarkChargeProductionCap().sub(tmp.qu.nanofield.antienergy)
  );
  if (tmp.qu.nanofield.producingCharge) nanofieldProducingChargeUpdating(diff);
  if (toAddAE.gt(0)) {
    tmp.qu.nanofield.antienergy = tmp.qu.nanofield.antienergy
      .add(toAddAE)
      .min(getQuarkChargeProductionCap());
    tmp.qu.nanofield.energy = tmp.qu.nanofield.energy.add(
      toAddAE.div(AErate).times(getQuarkEnergyProduction())
    );
...
function doAPGW() {
  if (
    !tmp.qu.nanofield.apgWoke &&
    tmp.qu.nanofield.rewards + (tmp.nf ? tmp.nf.extra : 0) >= tmp.apgw
  ) {
    tmp.qu.nanofield.apgWoke = tmp.apgw;
    if (!(tmp.ngp3c && (tmp.hb.higgs >= 2 || tmp.bd.unl))) {
      $.notify(
        "You reached " +
          getFullExpansion(tmp.apgw) +
          " rewards... The Anti-Preontius has woken up and took over the Nanoverse! Be careful!"
      );
      showTab("quantumtab");
...
function treeOfDecayUpdating(diff) {
  ...
  for (var c = 0; c < 3; c++) {
    ...
    var pseudoPower = Decimal.div(
      ug.gt(mult) ? ug.div(mult).log(2) + 1 : ug.div(mult),
      decayRate
    );
    var power = Decimal.div(
      branch.quarks.gt(mult)
        ? branch.quarks.div(mult).log(2) + 1
        : branch.quarks.div(mult),
      decayRate
    );
    ...
    branch.quarks = power.gt(1)
      ? Decimal.pow(2, power - 1).times(mult)
      : power.times(mult);
    branch.spin = branch.spin.add(
      sProd.times(
        tmp.ngp3c && player.masterystudies.includes("t432")
          ? pseudoPower.min(diff).max(decayed)
          : decayed
      )
    );
  }
...
function emperorDimUpdating(diff) {
  for (dim = 8; dim > 1; dim--) {
    ...
    if (canFeedReplicant(dim - 1, true)) {
      if (dim > 2)
        promote = tmp.eds[dim - 2].workers.sub(10).round().min(promote);
      tmp.eds[dim - 1].progress = tmp.eds[dim - 1].progress
        .add(
          tmp.eds[dim].workers
            .times(getEmperorDimensionMultiplier(dim))
            .times(diff / 200)
        )
        .min(promote);
      ...
      if (toAdd.gt(0)) {
        if (!hasNU(2)) {
          if (dim > 2 && toAdd.gt(getWorkerAmount(dim - 2)))
            tmp.eds[dim - 2].workers = new Decimal(0);
          else if (dim > 2)
            tmp.eds[dim - 2].workers = tmp.eds[dim - 2].workers
              .sub(toAdd)
              .round();
          else if (toAdd.gt(tmp.qu.replicants.amount))
            tmp.qu.replicants.amount = new Decimal(0);
          else
            tmp.qu.replicants.amount = tmp.qu.replicants.amount
              .sub(toAdd)
              .round();
        }
        if (toAdd.gt(tmp.eds[dim - 1].progress))
          tmp.eds[dim - 1].progress = new Decimal(0);
...
function replicantEggonUpdating(diff) {
  var newBabies = tmp.twr
    .times(getEmperorDimensionMultiplier(1))
    .times(getReplicantSpeed())
    .times(tmp.ngp3c ? 5 : 1)
    .times(diff / 200);
  if (player.achievements.includes("ng3p35")) newBabies = newBabies.times(10);
  tmp.qu.replicants.eggonProgress = tmp.qu.replicants.eggonProgress.add(
    newBabies
  );
  ...
  if (toAdd.gt(0)) {
    if (toAdd.gt(tmp.qu.replicants.eggonProgress))
      ...
      tmp.qu.replicants.eggonProgress = tmp.qu.replicants.eggonProgress.sub(
        toAdd
      );
...
function replicantBabyHatchingUpdating(diff) {
  if (tmp.qu.replicants.eggons.gt(0)) {
    tmp.qu.replicants.babyProgress = tmp.qu.replicants.babyProgress.add(
      diff / getHatchSpeed() / 10
    );
    var toAdd = hasNU(2)
      ? tmp.qu.replicants.eggons
      : tmp.qu.replicants.babyProgress.floor().min(tmp.qu.replicants.eggons);
    if (toAdd.gt(0)) {
      ...
      if (toAdd.gt(tmp.qu.replicants.babyProgress))
        ...
        tmp.qu.replicants.babyProgress = tmp.qu.replicants.babyProgress.sub(
          toAdd
        );
...
function replicantBabiesGrowingUpUpdating(diff) {
  if (tmp.qu.replicants.babies.gt(0) && tmp.tra.gt(0)) {
    tmp.qu.replicants.ageProgress = tmp.qu.replicants.ageProgress
      .add(getGrowupRatePerMinute().div(60).times(diff))
      .min(tmp.qu.replicants.babies);
    ...
    if (toAdd.gt(0)) {
      ...
      if (toAdd.gt(tmp.qu.replicants.ageProgress))
        ...
        tmp.qu.replicants.ageProgress = tmp.qu.replicants.ageProgress.sub(
          toAdd
        );
...
function replicantOverallUpdating(diff) {
  ...
  if (!tmp.qu.nanofield.producingCharge)
    tmp.qu.replicants.quarks = tmp.qu.replicants.quarks.add(
      getGatherRate().total.max(0).times(diff)
    );
}
...
function quantumOverallUpdating(diff) {
  ...
  //Color Powers
  for (var c = 0; c < 3; c++)
    tmp.qu.colorPowers[colorShorthands[c]] = tmp.qu.colorPowers[
      colorShorthands[c]
    ].add(getColorPowerProduction(colorShorthands[c]).times(diff));
  updateColorPowers();
...
function metaDimsUpdating(diff) {
  if (inQC("8c")) {
    player.meta.antimatter = player.meta.antimatter.plus(
      getMetaDimensionProduction(3).times(diff)
    );
    if (inQC(4))
      player.meta.antimatter = player.meta.antimatter.plus(
        getMetaDimensionProduction(3).times(diff)
    ...
    player.meta.antimatter = player.meta.antimatter.plus(
      getMetaDimensionProduction(1).times(diff)
    );
    if (inQC(4))
      player.meta.antimatter = player.meta.antimatter.plus(
        getMetaDimensionProduction(1).times(diff)
  ...
  if (tmp.ngp3 && !tmp.ngp3l && inQC(0))
    gainQuarkEnergy(player.meta.bestAntimatter, player.meta.antimatter);
  player.meta.bestAntimatter = player.meta.bestAntimatter.max(
    player.meta.antimatter
  );
  if (tmp.ngp3) {
    player.meta.bestOverQuantums = player.meta.bestOverQuantums.max(
      player.meta.antimatter
    );
    player.meta.bestOverGhostifies = player.meta.bestOverGhostifies.max(
      player.meta.antimatter
    );
  }
}
...
function infinityTimeMetaBlackHoleDimUpdating(diff) {
  ...
  for (let tier = 1; tier < 9; tier++) {
    if (tier < 9 - step) {
      ...
      ].amount.plus(DimensionProduction(tier + step).times(diff / 10));
      if (player.meta)
        player.meta[tier].amount = player.meta[tier].amount.plus(
          getMetaDimensionProduction(tier + step).times(diff / 10)
        );
    }
    if (tier < 9 - stepT)
      player["timeDimension" + tier].amount = player[
        "timeDimension" + tier
      ].amount.plus(getTimeDimensionProduction(tier + stepT).times(diff / 10));
    if (player.exdilation != undefined)
      if (isBHDimUnlocked(tier + step))
        player["blackholeDimension" + tier].amount = player[
          "blackholeDimension" + tier
        ].amount.plus(
          getBlackholeDimensionProduction(tier + step).times(diff / 10)
        );
  }
}
...
function dimensionPageTabsUpdating() {
  ...
  if (
    player.infDimensionsUnlocked[0] ||
    player.eternities !== 0 ||
    quantumed ||
    showProdTab ||
    player.aarexModifications.ngmX > 3
  ...
  document.getElementById("prodtabbtn").style.display = showProdTab
    ? "inline-block"
    : "none";
...
function otherDimsUpdating(diff) {
  if (player.currentEternityChall !== "eterc7" && !inQC("8c"))
    player.infinityPower = player.infinityPower.plus(
      DimensionProduction(1).times(diff)
    );
  ...
  if (player.currentEternityChall == "eterc7" || inQC("8c")) {
    ...
    if (tmp.be)
      player.timeShards = player.timeShards
        .plus(p.root(getBreakEternityTimeshardRoot()).times(diff))
        .max(p.root(getBreakEternityTimeshardRoot()).times(0));
  } else {
    if (ECTimesCompleted("eterc7") > 0)
      player.infinityDimension8.amount = player.infinityDimension8.amount.plus(
        DimensionProduction(9).times(diff)
      );
    player.timeShards = player.timeShards
      .plus(getTimeDimensionProduction(1).times(diff))
      .max(getTimeDimensionProduction(1).times(0));
  }

  if (inQC("8c"))
    player.timeDimension8.amount = player.timeDimension8.amount.plus(
      getMetaDimensionProduction(1).times(diff)
    );
}
...
function ERFreeTickUpdating() {
  ...
  player.tickspeed = player.tickspeed.times(
    Decimal.pow(tmp.tsReduce, player.totalTickGained - oldT)
  );
}
...
function nonERFreeTickUpdating() {
  ...
  var easier =
    player.galacticSacrifice && !(player.aarexModifications.ngmX > 3);
  if (easier) {
    thresholdMult = player.timestudy.studies.includes(171) ? 1.1 : 1.15;
    if (player.tickspeedBoosts != undefined)
      thresholdMult = player.timestudy.studies.includes(171) ? 1.03 : 1.05;
  ...
  if (ghostified && player.ghostify.neutrinos.boosts > 9)
    thresholdMult -= tmp.nb[10];
  if (thresholdMult < 1.1 && player.galacticSacrifice == undefined)
    thresholdMult = 1.05 + 0.05 / (2.1 - thresholdMult);
  if (thresholdMult < 1.01 && player.galacticSacrifice)
    thresholdMult = 1.005 + 0.005 / (2.01 - thresholdMult);
  gain = Math.ceil(
    new Decimal(player.timeShards).dividedBy(player.tickThreshold).log10() /
      Math.log10(thresholdMult)
  );
  player.totalTickGained += gain;
  player.tickspeed = player.tickspeed.times(Decimal.pow(tmp.tsReduce, gain));
  player.postC3Reward = Decimal.pow(
    getPostC3Mult(),
    gain * getIC3EffFromFreeUpgs()
  ).times(player.postC3Reward);
  var base =
    player.aarexModifications.ngmX > 3
      ? 0.01
      ...
      ? 0.1
      : 1;
  player.tickThreshold = Decimal.pow(
    thresholdMult,
    player.totalTickGained
  ).times(base);
  document.getElementById("totaltickgained").textContent =
...
function bigCrunchButtonUpdating() {
  ...
  if (tmp.ri) {
    ...
    if (player.money.gte(Number.MAX_VALUE)) {
      ...
      if (IPminpeak.log10() > 1e9)
        document.getElementById("postInfinityButton").innerHTML = "Big Crunch";
      else {
        var IPminpart =
          IPminpeak.log10() > 1e5
            ? ""
        ...
        document.getElementById("postInfinityButton").innerHTML =
          "<b>" +
          (IPminpeak.log10() > 3e5 ? "Gain " : "Big Crunch for ") +
...
function nextICUnlockUpdating() {
  ...
  if (nextUnlock == undefined)
    ...
    document.getElementById("nextchall").textContent =
      "Next challenge unlocks at " + shortenCosts(nextUnlock) + " antimatter.";
    ...
    if (getEternitied() > 6 && player.postChallUnlocked >= 8) {
      ...
      for (i = 0; i <= 8; i++)
        if (player.autobuyers[i] % 1 !== 0 && player.autobuyers[i].isOn)
          ndAutobuyersUsed++;
      document.getElementById("maxall").style.display =
        ndAutobuyersUsed > 8 && player.challenges.includes("postc8")
          ? "none"
          : "";
    }
  }
...
function giveBlackHolePowerUpdating(diff) {
  if (player.exdilation != undefined)
    player.blackhole.power = player.blackhole.power.plus(
      getBlackholeDimensionProduction(1).times(diff)
    );
}

function freeTickspeedUpdating() {
  if (player.boughtDims) ERFreeTickUpdating();
  if (player.timeShards.gt(player.tickThreshold) && !player.boughtDims)
    nonERFreeTickUpdating();
}
...
function replicantiIncrease(diff) {
  ...
  if (
    ...
    continuousReplicantiUpdating(diff);
  else notContinuousReplicantiUpdating();
  if (player.replicanti.amount.gt(0)) replicantiTicks += diff;

  if (
    tmp.ngp3 &&
    player.masterystudies.includes("d10") &&
    tmp.qu.autoOptions.replicantiReset &&
    player.replicanti.amount.gt(tmp.qu.replicants.requirement)
  )
    replicantReset(true);
  if (player.replicanti.galaxybuyer && player.aarexModifications.ngp3c)
    replCondense(true);
  if (
    player.replicanti.galaxybuyer &&
    canGetReplicatedGalaxy() &&
    canAutoReplicatedGalaxy()
  )
    replicantiGalaxy();
}
  ...
  if (player.infMultBuyer && (!player.boughtDims || canBuyIPMult())) {
    var dif =
      Math.floor(
        player.infinityPoints
          .div(player.infMultCost)
          .log(player.aarexModifications.newGameExpVersion ? 4 : 10)
      ) + 1;
    if (dif > 0) {
      player.infMult = player.infMult.times(Decimal.pow(getIPMultPower(), dif));
      player.infMultCost = player.infMultCost.times(
        Decimal.pow(ipMultCostIncrease, dif)
      );
      if (tmp.ngp3l || player.infinityPoints.lte(Decimal.pow(10, 1e9))) {
        if (ghostified) {
          if (player.ghostify.milestones < 11)
            player.infinityPoints = player.infinityPoints.minus(
              player.infMultCost
                .dividedBy(player.aarexModifications.newGameExpVersion ? 4 : 10)
                .min(player.infinityPoints)
            );
        } else
          player.infinityPoints = player.infinityPoints.minus(
            player.infMultCost
      ...
      if (
        ...
        player.autobuyers[11].priority = Decimal.times(
          player.autobuyers[11].priority,
          Decimal.pow(getIPMultPower(), dif)
        );
      if (player.autoCrunchMode == "amount")
        document.getElementById("priority12").value = formatValue(
          "Scientific",
...
function doEternityButtonDisplayUpdating(diff) {
  var isSmartPeakActivated =
    tmp.ngp3 &&
    getEternitied() >= 1e13 &&
    player.dilation.upgrades.includes("ngpp6");
  var EPminpeakUnits = isSmartPeakActivated
    ? player.dilation.active
      ? "TP"
      : tmp.be
      ? "EM"
  ...
  if (document.getElementById("eternitybtn").style.display == "inline-block") {
    document.getElementById("eternitybtnFlavor").textContent =
      (!player.dilation.active && gainedEternityPoints().lt(1e6)) ||
      player.eternities < 1 ||
      player.currentEternityChall !== "" ||
    ...
    if (
      ...
      document.getElementById("eternitybtnEPGain").innerHTML =
        "Reach " +
        shortenMoney(getReqForTPGain()) +
        " antimatter to gain more Tachyon Particles.";
    else {
      if (
        (EPminpeak.lt(Decimal.pow(10, 9)) && EPminpeakType == "logarithm") ||
        (EPminpeakType == "normal" && EPminpeak.lt(Decimal.pow(10, 1e9)))
      ) {
        document.getElementById("eternitybtnEPGain").innerHTML =
          player.eternities > 0 &&
          (player.currentEternityChall == "" ||
            ...
            ? "Gain <b>" +
              (player.dilation.active
                ? shortenMoney(
                    getDilGain().sub(player.dilation.totalTachyonParticles)
                  )
    ...
    var showEPmin =
      ...
      player.options.notation != "Morse code" &&
      player.options.notation != "Spazzy" &&
      (!(player.dilation.active || tmp.be) || isSmartPeakActivated);
    if (EPminpeak.log10() < 1e5) {
      document.getElementById("eternitybtnRate").textContent =
        showEPmin &&
        (EPminpeak.lt("1e30003") ||
          player.options.theme == "Aarex's Modifications")
          ? (EPminpeakType == "normal"
              ? shortenDimensions(currentEPmin)
              : shorten(currentEPmin)) + EPminpeakUnits
          : "";
...
function doQuantumButtonDisplayUpdating(diff) {
  ...
  if (quantumed && isQuantumReached()) {
    ...
    if (!bigRipped) {
      ...
      if (
        currentQKmin.gt(QKminpeak) &&
        player.meta.antimatter.gte(
          Decimal.pow(Number.MAX_VALUE, tmp.ngp3 ? 1.2 : 1)
        )
      ) {
  ...
  document.getElementById("quantumbtnFlavor").textContent =
    ((tmp.qu !== undefined
      ? !tmp.qu.times &&
        (player.ghostify !== undefined ? !player.ghostify.milestones : true)
      : false) || !inQC(0)
      ? ((tmp.ngp3 ? tmp.qu.bigRip.active : false)
          ? "I am"
          : inQC(0)
          ? "My computer is"
          : tmp.qu.challenge.length > 1
          ? "These paired challenges are"
          : "This challenge is") + " not powerful enough... "
      : "") + "I need to go quantum.";
  var showGain =
    ((quantumed && tmp.qu.times) ||
      (ghostified && player.ghostify.milestones)) &&
    (inQC(0) || player.options.theme == "Aarex's Modifications")
      ? "QK"
      : "";
  if (tmp.ngp3) if (tmp.qu.bigRip.active) showGain = "SS";
  document.getElementById("quantumbtnQKGain").textContent =
    showGain == "QK"
      ? "Gain " +
  ...
  if (showGain == "SS")
    document.getElementById("quantumbtnQKGain").textContent =
      "Gain " + shortenDimensions(getSpaceShardsGain()) + " Space Shards.";
  if (showGain == "QK" && currentQKmin.gt(Decimal.pow(10, 1e5))) {
    ...
    document.getElementById("quantumbtnRate").textContent =
      showGain == "QK" ? shortenMoney(currentQKmin) + " QK/min" : "";
    var showQKPeakValue =
      QKminpeakValue.lt(1e30) ||
      player.options.theme == "Aarex's Modifications";
    document.getElementById("quantumbtnPeak").textContent =
      showGain == "QK"
        ? (showQKPeakValue ? "" : "Peaked at ") +
          shortenMoney(QKminpeak) +
          " QK/min" +
          (showQKPeakValue
            ? " at " + shortenDimensions(QKminpeakValue) + " QK"
            : "")
        : "";
  }
}
...
function doGhostifyButtonDisplayUpdating(diff) {
  ...
  if (ghostified && player.achievements.includes("ng3p78"))
    ghostifyGains.push(
      shortenDimensions(
        Decimal.times(6e3 * tmp.qu.bigRip.bestGals, getGhostifiedGain()).times(
          getNeutrinoGain()
        )
      ) + " Neutrinos"
    );
  ...
  document.getElementById("ghostifybtnFlavor").textContent =
    ghostifyGains.length > 1
      ? ""
      : (ghostifyGains.length
          ? ""
          : "I need to ascend from this broken universe... ") +
        "I need to become a ghost.";
  document.getElementById("GHPGain").textContent = ghostifyGains.length
    ? "Gain " +
      ghostifyGains[0] +
      (ghostifyGains.length > 2 ? ", " + ghostifyGains[1] + "," : "") +
      (ghostifyGains.length > 1
        ? " and " + ghostifyGains[ghostifyGains.length - 1]
        : "") +
      "."
    : "";
  var showGHPPeakValue =
    GHPminpeakValue.lt(1e6) || player.options.theme == "Aarex's Modifications";
  document.getElementById("GHPRate").textContent =
    ghostifyGains.length == 1 && showGHPPeakValue
      ? getGHPRate(currentGHPmin)
      : "";
  document.getElementById("GHPPeak").textContent =
    ghostifyGains.length == 1
      ? (showGHPPeakValue ? "" : "Peaked at ") +
        getGHPRate(GHPminpeak) +
        (showGHPPeakValue
          ? " at " + shortenDimensions(GHPminpeakValue) + " GhP"
          : "")
      : "";
}
...
function passiveGPGen(diff) {
  ...
  if (player.tickspeedBoosts != undefined)
    passiveGPGen = player.achievements.includes("r56");
  else if (player.galacticSacrifice)
    passiveGPGen = !tmp.ngp3l && player.timestudy.studies.includes(181);
  var mult = 1;
  if (player.aarexModifications.ngmX >= 4) {
    if (player.achievements.includes("r43")) {
      mult =
        Math.pow(
          player.galacticSacrifice.galaxyPoints.plus(1e20).log10() / 10,
          2
        ) / 2;
    }
  ...
  if (passiveGPGen)
    player.galacticSacrifice.galaxyPoints = player.galacticSacrifice.galaxyPoints.add(
      getGSAmount().times((diff / 100) * mult)
    );
}
...
function paradoxSacDisplay() {
  if (pSacrificed()) {
    ...
    document.getElementById("px").innerHTML =
      "You have <span class='pxAmount'>" +
      shortenDimensions(player.pSac.px) +
      "</span> Paradox" +
      (player.galacticSacrifice.galaxyPoints.eq(1) ? "." : "es.");
  } else {
...
function galSacDisplay() {
  if (
    ...
    document.getElementById("galaxyPoints2").innerHTML =
      "You have <span class='GPAmount'>" +
      shortenDimensions(player.galacticSacrifice.galaxyPoints) +
      "</span> Galaxy point" +
      (player.galacticSacrifice.galaxyPoints.eq(1) ? "." : "s.");
  } else document.getElementById("galaxybtn").style.display = "none";
  document.getElementById("automationbtn").style.display =
    player.aarexModifications.ngmX > 3 &&
...
function DimBoostBulkDisplay() {
  var bulkDisplay =
    player.infinityUpgrades.includes("bulkBoost") ||
    player.autobuyers[9].bulkBought === true
      ? "inline"
      : "none";
...
function preBreakProgess() {
  var p =
    Math.min(
      (Decimal.log10(player.money.plus(1)) / Decimal.log10(getLimit())) * 100,
      100
    ).toFixed(2) + "%";
  document.getElementById("progressbar").style.width = p;
  document.getElementById("progresspercent").textContent = p;
...
function infDimProgress() {
  var p =
    Math.min((player.money.e / getNewInfReq().money.e) * 100, 100).toFixed(2) +
    "%";
  document.getElementById("progressbar").style.width = p;
  document.getElementById("progresspercent").textContent = p;
  document
...
function r138Progress() {
  var p =
    Math.min(Decimal.log10(player.infinityPoints.plus(1)) / 200, 100).toFixed(
      2
    ) + "%";
  document.getElementById("progressbar").style.width = p;
  document.getElementById("progresspercent").textContent = p;
...
function preQuantumNormalProgress() {
  ...
  var goal = Math.pow(
    2,
    Math.ceil(Math.log10(Math.max(gepLog, 1)) / Math.log10(2))
  );
  if (goal > 131072 && player.meta && !player.achievements.includes("ngpp13")) {
    ...
    var percentage =
      Math.max(Math.min((gepLog / goal) * 100, 100), 0).toFixed(2) + "%";
    document.getElementById("progressbar").style.width = percentage;
    document.getElementById("progresspercent").textContent = percentage;
    document
      .getElementById("progresspercent")
      .setAttribute(
        "ach-tooltip",
        "Percentage to " + shortenDimensions(Decimal.pow(2, goal)) + " EP gain"
      );
  }
}
...
function progressBarUpdating() {
  ...
  if (document.getElementById("metadimensions").style.display == "block")
    ...
    (!inQC(0) || gainedEternityPoints().gte(Decimal.pow(2, 1048576))) &&
    player.meta
  )
    doQuantumProgress();
...
function ECRewardDisplayUpdating() {
  ...
  document.getElementById("ec7reward").textContent =
    "Reward: First Time Dimensions produce Eighth Infinity Dimensions. Currently: " +
    shortenMoney(DimensionProduction(9)) +
    " per second. ";
  document.getElementById("ec8reward").textContent =
    "Reward: Infinity Power powers up replicanti galaxies. Currently: " +
    (getECReward(8) * 100 - 100).toFixed(2) +
    "%";
  document.getElementById("ec9reward").textContent =
    "Reward: Infinity Dimensions gain a " +
    (player.galacticSacrifice ? "post dilation " : "") +
    " multiplier based on your Time Shards. Currently: " +
    shortenMoney(getECReward(9)) +
    "x ";
  document.getElementById("ec10reward").textContent =
    "Reward: Time Dimensions gain a multiplier from your Infinities. Currently: " +
    shortenMoney(getECReward(10)) +
    "x ";
  document.getElementById("ec11reward").textContent =
    ...
    (player.aarexModifications.ngp3c
      ? ", and galaxies are " +
        shorten((getECReward(11) - 1) * 100) +
        "% stronger (based on free tickspeed upgrades)"
      : " ");
  document.getElementById("ec12reward").textContent =
    "Reward: Infinity Dimension cost multipliers are reduced. (x^" +
    getECReward(12) +
    ")";
  document.getElementById("ec13reward").textContent =
    "Reward: Increase the exponent of " +
    (player.aarexModifications.ngp3c ? "infinity power and " : "") +
    "meta-antimatter's effect (+" +
    getECReward(13) +
    ")" +
    (player.aarexModifications.ngp3c
      ? ", and replicate chance increases the replicanti limit (" +
        shorten(getECReward(13, true)) +
        "x)"
      : "");
  document.getElementById("ec14reward").textContent =
    "Reward: Free tickspeed upgrades boost the IC3 reward to be " +
    getIC3EffFromFreeUpgs().toFixed(0) +
    "x stronger" +
    (player.aarexModifications.ngp3c
      ? ", and normal galaxies make dilated & meta condensers " +
        ((getECReward(14, true) - 1) * 100).toFixed(2) +
        "% stronger"
      : "");

  document.getElementById("ec10span").textContent =
    shortenMoney(ec10bonus) + "x";
  document.getElementById("eterc7ts").textContent = player.aarexModifications
    .ngp3c
    ? "does nothing"
    : "affects all dimensions normally";
}

function bigRipUpgradeUpdating() {
  if (player.ghostify.milestones > 7) {
    document.getElementById("spaceShards").textContent = shortenDimensions(
      tmp.qu.bigRip.spaceShards
    );
    for (var u = 1; u <= getMaxBigRipUpgrades(); u++) {
      document.getElementById(
        "bigripupg" + u
      ).className = tmp.qu.bigRip.upgrades.includes(u)
        ? "gluonupgradebought bigrip" +
          (isBigRipUpgradeActive(u, true) ? "" : "off")
        : tmp.qu.bigRip.spaceShards.lt(getBigRipUpgCost(u))
        ? "gluonupgrade unavailablebtn"
        : "gluonupgrade bigrip";
      document.getElementById(
        "bigripupg" + u + "cost"
      ).textContent = shortenDimensions(new Decimal(getBigRipUpgCost(u)));
    }
  }
  document.getElementById("bigripupg1current").textContent = shortenDimensions(
    tmp.bru[1]
  );
  document.getElementById("bigripupg4current").textContent = shortenDimensions(
    tmp.bru[4]
  );
  document.getElementById("bigripupg6current").textContent = shortenDimensions(
    tmp.qu.bigRip.active ? tmp.qu.bigRip.spaceShards.max(1) : 1
  );
  document.getElementById("bigripupg8current").textContent =
    shortenDimensions(tmp.bru[8]) +
    (Decimal.gte(tmp.bru[8], Number.MAX_VALUE) && !hasNU(11) ? "x (cap)" : "x");
  document.getElementById(
    "bigripupg14current"
  ).textContent = tmp.bru[14].toFixed(2);
  var bru15effect = tmp.bru[15];
  document.getElementById("bigripupg15current").textContent =
    bru15effect < 999.995
      ? bru15effect.toFixed(2)
      : getFullExpansion(Math.round(bru15effect));
  document.getElementById("bigripupg16current").textContent = shorten(
    tmp.bru[16]
  );
  document.getElementById("bigripupg17current").textContent = tmp.bru[17];
  if (player.ghostify.ghostlyPhotons.unl) {
    document.getElementById("bigripupg18current").textContent = shorten(
      tmp.bru[18]
    );
    document.getElementById("bigripupg19current").textContent = shorten(
      tmp.bru[19]
    );
  }
}
...
function challengeOverallDisplayUpdating() {
  if (document.getElementById("challenges").style.display == "block") {
    if (document.getElementById("eternitychallenges").style.display == "block")
      ECRewardDisplayUpdating();
    if (document.getElementById("quantumchallenges").style.display == "block") {
      if (tmp.qu.autoOptions.sacrifice || tmp.ngp3c)
        document.getElementById("electronsAmount2").textContent =
          "You have " +
          getFullExpansion(Math.round(tmp.qu.electrons.amount)) +
          " electrons.";
      for (var c = 1; c < 7; c++) {
        if (c == 5)
          document.getElementById(
            "qc5reward"
          ).textContent = getDimensionPowerMultiplier("linear").toFixed(2);
        else if (c != 2)
          document.getElementById("qc" + c + "reward").textContent = shorten(
            tmp.qcRewards[c]
          );
      }
...
function infDimTabUpdating() {
  document.getElementById("idtabbtn").style.display =
    (player.infDimensionsUnlocked[0] || player.eternities > 0 || quantumed) &&
    !inQC(8)
      ? ""
      : "none";
}
...
function galaxyBtnUpdating() {
  if (
    getAmount(inNC(4) || player.pSac != undefined ? 6 : 8) >=
    getGalaxyRequirement()
  ) {
...
function newIDDisplayUpdating() {
  ...
  if (getEternitied() > 24) {
    while (req.money.lt(player.money) && !player.infDimensionsUnlocked[7]) {
      newDimension();
      if (
        player.infDimBuyers[req.tier - 1] &&
        player.currentEternityChall != "eterc8"
      )
...
function d8SacDisplay() {
  if (calcTotalSacrificeBoost().lte(Decimal.pow(10, 1e9))) {
    ...
    document
      .getElementById("sacrifice")
      .setAttribute("ach-tooltip", "Boost the 8th Dimension");
    document.getElementById("sacrifice").textContent =
      "Dimensional Sacrifice (Total: " +
      formatValue(player.options.notation, calcTotalSacrificeBoost(), 2, 2) +
      "x)";
  }
}
...
function pSacBtnUpdating() {
  if (canPSac()) {
    ...
    document.getElementById("pSac").innerHTML =
      "Paradox Sacrifice for " +
      shortenDimensions(px) +
      " Paradox" +
      (px.eq(1) ? "." : "es.");
...
function galSacBtnUpdating() {
  ...
  if (document.getElementById("gSacrifice").style.display === "inline-block") {
    document.getElementById("gSacrifice").innerHTML =
      "Galactic Sacrifice (" +
      formatValue(player.options.notation, getGSAmount(), 2, 0) +
      " GP)";
    document
      .getElementById("gSacrifice")
      .setAttribute(
        "ach-tooltip",
        "Gain " +
          formatValue(player.options.notation, getGSAmount(), 2, 0) +
    ...
    if (getGSAmount().gt(0)) {
      ...
      var currentGPmin = getGSAmount().dividedBy(
        player.galacticSacrifice.time / 600
      );
      if (currentGPmin.gt(GPminpeak)) GPminpeak = currentGPmin;
      var notationOkay =
        (GPminpeak.gt("1e300000") &&
          player.options.theme != "Aarex's Modifications") ||
        player.options.notation == "Morse code" ||
        player.options.notation == "Spazzy";
      var notation2okay =
        ...
        player.options.notation == "Morse code" ||
        player.options.notation == "Spazzy";
      document.getElementById("sacrificebtn").innerHTML =
        (notationOkay ? "Gain " : "Galactic Sacrifice for ") +
        shortenDimensions(getGSAmount()) +
        " Galaxy points." +
        (notation2okay
          ? ""
          : "<br>" +
            shortenMoney(currentGPmin) +
            " GP/min" +
            "<br>Peaked at " +
            shortenMoney(GPminpeak) +
            " GP/min");
...
function IPonCrunchPassiveGain(diff) {
  if (player.timestudy.studies.includes(181))
    player.infinityPoints = player.infinityPoints.plus(
      gainedInfinityPoints().times(diff / 100)
    );
}
...
function EPonEternityPassiveGain(diff) {
  if (tmp.ngp3) {
    if (player.masterystudies.includes("t291")) {
      player.eternityPoints = player.eternityPoints.plus(
        gainedEternityPoints().times(diff / 100)
      );
      document.getElementById("eternityPoints2").innerHTML =
        'You have <span class="EPAmount2">' +
        shortenDimensions(player.eternityPoints) +
        "</span> Eternity points.";
    }
  }
}
...
function ngp3DilationUpdating() {
  let gain = getDilGain();
  if (player.galacticSacrifice !== undefined)
    player.dilation.bestIP = player.infinityPoints.max(player.dilation.bestIP);
  if (
    player.dilation.tachyonParticles.lt(gain) &&
    player.masterystudies.includes("t292")
  )
    setTachyonParticles(gain);
}
...
function setTachyonParticles(x) {
  ...
  if (
    ...
    player.dilation.bestTP = Decimal.max(
      player.dilation.bestTP || 0,
      player.dilation.tachyonParticles
    );
    player.dilation.bestTPOverGhostifies = player.dilation.bestTPOverGhostifies.max(
      player.dilation.bestTP
    );
    document.getElementById("bestTP").textContent =
      "Your best" +
      (ghostified ? "" : " ever") +
...
function passiveQuantumLevelStuff(diff) {
  if (tmp.qu.bigRip.active || hasBosonicUpg(24)) {
    tmp.qu.bigRip.spaceShards = tmp.qu.bigRip.spaceShards.add(
      getSpaceShardsGain().times(diff / 100)
    );
    if (tmp.ngp3c && tmp.qu.bigRip.tss)
      tmp.qu.bigRip.tss = tmp.qu.bigRip.tss.add(
        getSpaceShardsGain().times(diff / 100)
      );
  }
  if (!tmp.qu.bigRip.active) {
    ...
    var p = ["rg", "gb", "br"];
    for (var i = 0; i < 3; i++) {
      var r = tmp.qu.usedQuarks[p[i][0]]
        .min(tmp.qu.usedQuarks[p[i][1]])
        .min(tmp.ngp3c ? tmp.qu.quarkEnergy.div(3) : 1 / 0);
      if (player.achievements.includes("ng3p71")) r = r.div(100);
      else r = r.sqrt();
      tmp.qu.gluons[p[i]] = tmp.qu.gluons[p[i]].add(r.times(diff));
    }
    if (player.ghostify.milestones > 15)
      tmp.qu.quarks = tmp.qu.quarks.add(quarkGain().times(diff / 100));
  }
  if (
    (tmp.be && player.ghostify.milestones > 14) ||
    (tmp.qu.breakEternity.break && hasAch("ng3pc13"))
  )
    tmp.qu.breakEternity.eternalMatter = tmp.qu.breakEternity.eternalMatter.add(
      getEMGain().times(diff / 100)
    );
  updateQuarkDisplay();
...
function TTpassiveGain(diff) {
  if (player.dilation.upgrades.includes(10)) {
    ...
    if (nG(nMx(speed, player.timestudy.theorem), 1e200) && !tmp.ngp3c) {
      ...
      if (nL(div, 3600) && player.achievements.includes("ng3p44"))
        player.timestudy.theorem = nA(
          player.timestudy.theorem,
          nM(speed, Math.min(diff * 9, 3600 - new Decimal(div).toNumber()))
        );
      if (player.timestudy.theorem > 1e200 && !tmp.ngp3c)
        player.timestudy.theorem = 1e200;
    }
  }
}
...
function thisQuantumTimeUpdating() {
  setAndMaybeShow(
    "quantumClock",
    tmp.ngp3
      ? quantumed && tmp.qu.times > 1 && speedrunMilestonesReached < 28
      : false,
    '"Quantum time: <b class=\'QKAmount\'>"+timeDisplayShort(tmp.qu.time)+"</b>"'
  );
}
...
function infUpgPassiveIPGain(diff) {
  if (diff > player.autoTime && !player.break)
    player.infinityPoints = player.infinityPoints.plus(
      player.autoIP.div(player.autoTime).times(diff)
    );
}
...
function gameLoop(diff) {
  ...
  document.getElementById("IPPeakDiv").style.display =
    player.break && player.boughtDims ? "" : "none";
  ...
  if (player.dilation.studies.includes(1))
    player.dilation.dilatedTime = player.dilation.dilatedTime.plus(
      getDilTimeGainPerSecond().times(diff)
    );
  ...
  document.getElementById("challengesbtn").style.display =
    player.challenges.includes("challenge1") && !isEmptiness
      ? "inline-block"
      : "none";
  document.getElementById("infinitybtn").style.display =
    (player.infinitied > 0 ||
      player.infinityPoints.gt(0) ||
      player.eternities !== 0 ||
      quantumed) &&
    !isEmptiness
      ? "inline-block"
  ...
  if (
    player.aarexModifications.ngp3c &&
    document.getElementById("acnd").style.display != "none"
  )
    updateObscurements();
  ...
  document.getElementById("infinityPoints1").innerHTML =
    'You have <span class="IPAmount1">' + s + "</span> Infinity points.";
  document.getElementById("infinityPoints2").innerHTML =
    'You have <span class="IPAmount2">' + s + "</span> Infinity points.";
...
function simulateTime(seconds, real, id) {
  ...
  if (storage.dt)
    if (player.dilation.dilatedTime.gt(storage.dt))
      popupString +=
        ",<br> dilated time increased " +
        shortenMoney(
          player.dilation.dilatedTime.log10() -
            Decimal.max(storage.dt, 1).log10()
        ) +
        " orders of magnitude";
  if (storage.bp)
    if (player.blackhole.power.gt(storage.bp))
      popupString +=
        ",<br> black hole power increased " +
        shortenMoney(
          player.blackhole.power.log10() - Decimal.max(storage.bp, 1).log10()
        ) +
        " orders of magnitude";
  if (storage.ma)
    if (player.meta.antimatter.gt(storage.ma))
      popupString +=
        ...
        shortenMoney(
          player.meta.antimatter.log10() - Decimal.max(storage.ma, 1).log10()
        ) +
        " orders of magnitude";
  if (storage.dt) {
    if (tmp.qu.electrons.amount > storage.ec)
      popupString +=
        ",<br> electrons increased by " +
        getFullExpansion(Math.round(tmp.qu.electrons.amount - storage.ec));
    if (tmp.qu.replicants.amount.gt(storage.nr))
      popupString +=
        ",<br> normal replicants increased " +
        shortenMoney(
          tmp.qu.replicants.amount.log10() - Decimal.max(storage.nr, 1).log10()
        ) +
        " orders of magnitude";
    if (player.ghostify.bl.am.gt(storage.ma))
      popupString +=
        ",<br> Bosonic Antimatter increased " +
        shortenMoney(
          player.ghostify.bl.am.log10() - Decimal.max(storage.bAm, 1).log10()
        ) +
        " orders of magnitude";
  }
  if (
  ...
  if (player.infinitied > playerStart.infinitied)
    popupString +=
      "<br>you infinitied " +
      getFullExpansion(player.infinitied - playerStart.infinitied) +
      " times.";
  if (player.eternities > playerStart.eternities)
    popupString +=
      " <br>you eternitied " +
      getFullExpansion(player.eternities - playerStart.eternities) +
      " times.";
...
function startInterval() {
  gameLoopIntervalId = setInterval(function () {
    if (
      player.aarexModifications.performanceTicks &&
      new Date().getTime() - tickWaitStart < tickWait
    )
      return;
    tickWait = 1 / 0;
...
function updateChart(first) {
  if (player.options.chart.on === true && first !== true)
...
function dimBoolean() {
  ...
  if (
    getEternitied() < 10 &&
    !player.autobuyers[9].bulkBought &&
    amount < getShiftRequirement(player.autobuyers[9].bulk - 1).amount
  )
    return false;
  if (player.overXGalaxies <= player.galaxies) return true;
  if (
    player.autobuyers[9].priority < req.amount &&
    req.tier == (inNC(4) || player.currentChallenge == "postc1" ? 6 : 8)
  )
    return false;
  return true;
}
...
function maxBuyGalaxies(manual) {
  ...
  if (player.autobuyers[10].priority > player.galaxies || manual) {
    ...
    var check = 0;
    while (
      amount >= getGalaxyRequirement(increment * 2) &&
      (player.autobuyers[10].priority > player.galaxies + increment * 2 ||
        manual)
    )
      increment *= 2;
    while (increment >= 1) {
      ...
      if (
        amount >= getGalaxyRequirement(check) &&
        (player.autobuyers[10].priority > player.galaxies + check || manual)
      )
        toSkip += increment;
      increment /= 2;
    }
...
function autoQuantumABTick() {
  if (tmp.qu.autobuyer.mode == "amount") {
    ...
    if (
      quarkGain().gte(
        Decimal.round(tmp.qu.autobuyer.limit).times(tmp.qu.last10[0][1])
      )
    )
      quantum(true, false, 0);
    ...
    if (
      tmp.qu.autobuyer.peakTime >=
      new Decimal(tmp.qu.autobuyer.limit).toNumber()
    )
      quantum(true, false, 0);
  } else if (tmp.qu.autobuyer.mode == "dilation") {
    if (
      player.dilation.times >=
      Math.round(new Decimal(tmp.qu.autobuyer.limit).toNumber())
    )
      quantum(true, false, 0);
  }
}
...
function autoEternityABTick() {
  if (player.autoEterMode === undefined || player.autoEterMode == "amount") {
    ...
    if (
      player.thisEternity / 10 >=
      new Decimal(player.eternityBuyer.limit).toNumber()
    )
      eternity(false, true);
  } else if (player.autoEterMode == "relative") {
    if (
      gainedEternityPoints().gte(
        player.lastTenEternities[0][1].times(player.eternityBuyer.limit)
      )
    )
      eternity(false, true);
    ...
    if (
      player.peakSpent >=
        new Decimal(player.eternityBuyer.limit).toNumber() * 10 &&
      EPminpeak.gt(0)
    )
      eternity(false, true);
    ...
    if (
      nG(
        ...
        nM(eternitied, new Decimal(player.eternityBuyer.limit).toNumber())
      )
    )
      eternity(false, true);
  }
...
function galSacABTick() {
  if (
    player.autobuyers[12].ticks * 100 >= player.autobuyers[12].interval &&
    getGSAmount().gte(player.autobuyers[12].priority) &&
    player.autobuyers[12].isOn
  ) {
...
function galaxyABTick() {
  if (
    ...
    getAmount(inNC(4) || player.pSac != undefined ? 6 : 8) >=
      getGalaxyRequirement() &&
    (!inNC(14) || !(player.aarexModifications.ngmX > 3))
  ) {
    if (getEternitied() < 9) {
      if (
  ...
  if (player.autobuyers[9].isOn && dimBoolean()) {
    if (player.resets < 4) softReset(1);
      ...
      Math.round(timer * 100) % Math.round(player.autobuyers[9].bulk * 100) ==
        0 &&
      getAmount(8) >= getShiftRequirement(0).amount
    )
      maxBuyDimBoosts();
...
function autoBuyerTick() {
  ...
  if (player.autobuyers[11] % 1 !== 0) {
    if (
      ...
      player.money.gte(
        player.currentChallenge == "" ? getLimit() : player.challengeTarget
      )
    ) {
      if (player.autobuyers[11].isOn) {
        if (
          (!player.autobuyers[11].requireIPPeak ||
            IPminpeak.gt(
              gainedInfinityPoints().div(player.thisInfinityTime / 600)
            )) &&
          player.autobuyers[11].priority
        ) {
          if (player.autoCrunchMode == "amount") {
            if (
              !player.break ||
              player.currentChallenge != "" ||
              gainedInfinityPoints().gte(player.autobuyers[11].priority)
            ) {
              autoS = false;
              bigCrunch(true);
            }
            ...
            if (
              ...
              player.thisInfinityTime / 10 >=
                new Decimal(player.autobuyers[11].priority).toNumber()
            ) {
              autoS = false;
              bigCrunch(true);
            }
            ...
            if (
              ...
              player.currentChallenge != "" ||
              (player.replicanti.galaxies >=
                (player.autobuyers[11].priority.toString().toLowerCase() ==
                "max"
                ...
                (!player.autobuyers[11].requireMaxReplicanti ||
                  player.replicanti.amount.gte(getReplicantiLimit())))
            ) {
              autoS = false;
              bigCrunch(true);
            }
  ...
  if (player.galacticSacrifice)
    if (player.autobuyers[12] % 1 !== 0) galSacABTick();
  if (player.tickspeedBoosts != undefined)
    if (player.autobuyers[13] % 1 !== 0) TSBoostABTick();
  if (player.aarexModifications.ngmX > 3)
    if (player.autobuyers[14] % 1 !== 0) TDBoostABTick();

  if (player.autoSacrifice % 1 !== 0) {
    if (
      (player.galacticSacrifice
        ? player.autoSacrifice.ticks * 100 >= player.autoSacrifice.interval
        : true) &&
...
function showDimTab(tabName) {
  ...
  if (
    ...
    player.aarexModifications.progressBar &&
    (tabName === "antimatterdimensions" || tabName === "metadimensions")
  )
    document.getElementById("progress").style.display = "block";
  else document.getElementById("progress").style.display = "none";
}
...
function toggleProgressBar() {
  player.aarexModifications.progressBar = !player.aarexModifications
    .progressBar;
  document.getElementById("progressBarBtn").textContent =
    (player.aarexModifications.progressBar ? "Hide" : "Show") + " progress bar";
}
...
function showEternityTab(tabName, init) {
  ...
  if (
    (tabName === "timestudies" ||
      tabName === "ers_timestudies" ||
      tabName === "masterystudies") &&
    !init
  )
    document.getElementById("TTbuttons").style.display = "block";
  else document.getElementById("TTbuttons").style.display = "none";
...
function getUnspentBonus() {
  ...
  if (player.galacticSacrifice)
    return x
      .pow(Math.max(Math.min(Math.pow(x.max(1).log(10), 1 / 3) * 3, 8), 1))
      .plus(1);
  else
    return x
      .dividedBy(2)
      .pow(1.5)
      .plus(1)
      .pow(player.aarexModifications.ngp3c ? 5 : 1);
}
...
function getAchievementMult() {
  ...
  var gups = player.galacticSacrifice
    ? player.galacticSacrifice.upgrades.length
    : 0;
...
function updatePowers() {
  ...
  if (player.boughtDims)
    mult18 = getDimensionFinalMultiplier(1)
      .max(1)
      .times(getDimensionFinalMultiplier(8).max(1))
      .pow(0.02);
  else
    mult18 = getDimensionFinalMultiplier(1)
...
function switchDecimalMode() {
  if (
    confirm(
      "You will change the number library preference to " +
        (player.aarexModifications.breakInfinity
          ? "logarithmica_numerus_lite"
          : "break_infinity.min") +
        ".js. This requires the webpage to reload for this to take effect. Are you sure you want to do this?"
    )
  ) {
    player.aarexModifications.breakInfinity = !player.aarexModifications
      .breakInfinity;
    if (
      ...
      !player.aarexModifications.performanceTicks &&
      confirm(
        "WARNING: The game may become laggy with this library! Do you want to turn on Performance Ticks? This will increase the performance of the game, but may cause detrimental effects for lower-end computers. The option for Performance Ticks can be changed at any time."
      )
    )
