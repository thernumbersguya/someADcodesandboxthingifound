...
dev.ghostify = function(gain, amount, seconds=4) {
	...
	setTimeout(function() {
		document.getElementById("ghostifyanigained").innerHTML = ghostified ? "You now have <b>" + shortenDimensions(amount) + "</b> Ghost Particles. (+" + shortenDimensions(gain) + ")" : "Congratulations for beating a PC with QCs "+(tmp.ngp3c?"6, 7, & 8":"6 & 8")+" combination!"
